...
@media screen and (min-width:480px) and (max-width:639px){
  ...
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768561543117000001"]{display:none!important;}
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768561554348000002"]{display:block!important;top:1560px!important;left:calc(50% - 240px + 10px)!important;width:460px!important;height:auto!important;text-align:center!important;}
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768561554348000002"] .clean-node-atom{display:block!important;font-size:0!important;line-height:0!important;white-space:normal!important;}
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768561554348000002"] .clean-node-atom::before,
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768561554348000002"] .clean-node-atom::after{display:block;color:#313131;font-family:var(--clean-headline-font,Georgia,serif);font-size:26px;font-weight:400;line-height:1.22;}
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768561554348000002"] .clean-node-atom::before{content:"Not sure which frequency?";}
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768561554348000002"] .clean-node-atom::after{content:"and we'll help you decide.";margin-top:2px;}
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768238331289000005"]{top:1648px!important;left:calc(50% - 240px + 145px)!important;width:190px!important;height:44px!important;}
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768238331289000005"] .clean-node-atom{font-size:16px!important;}
  .clean-service-page #section1778724733 .clean-stage__artboard,
  .clean-service-page #section1778724733 .clean-stage__filter,
  .clean-service-page #section1778724733 .clean-stage__carrier{height:2140px!important;}
  .clean-service-page #section1793182383 .clean-stage__artboard,
  .clean-service-page #section1793182383 .clean-stage__filter,
  .clean-service-page #section1793182383 .clean-stage__carrier{height:1018px!important;}
  .clean-service-page #section1793182383 .clean-node-elem[data-clean-id="1767791730577"]{top:20px!important;}
  .clean-service-page #section1793182383 .clean-node-elem:not([data-clean-id="1767791730577"]){transform:translate3d(0,-70px,0);}
}
@media screen and (max-width:479px){
  ...
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768561554348000002"]{display:none!important;}
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768561543117000001"]{display:block!important;top:1364px!important;left:calc(50% - 160px + 10px)!important;width:300px!important;height:auto!important;text-align:center!important;}
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768561543117000001"] .clean-node-atom{display:block!important;font-size:0!important;line-height:0!important;white-space:normal!important;}
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768561543117000001"] .clean-node-atom::before,
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768561543117000001"] .clean-node-atom::after{display:block;color:#313131;font-family:var(--clean-headline-font,Georgia,serif);font-size:22px;font-weight:400;line-height:1.2;}
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768561543117000001"] .clean-node-atom::before{content:"Not sure which frequency?";}
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768561543117000001"] .clean-node-atom::after{content:"and we'll help you decide.";margin-top:2px;}
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768238331289000005"]{top:1438px!important;left:calc(50% - 160px + 75px)!important;width:170px!important;height:38px!important;}
  .clean-service-page #section1778645403 .clean-node-elem[data-clean-id="1768238331289000005"] .clean-node-atom{font-size:14px!important;}
  .clean-service-page #section1778724733 .clean-stage__artboard,
  .clean-service-page #section1778724733 .clean-stage__filter,
  .clean-service-page #section1778724733 .clean-stage__carrier{height:2151px!important;}
  .clean-service-page #section1793182383 .clean-stage__artboard,
  .clean-service-page #section1793182383 .clean-stage__filter,
  .clean-service-page #section1793182383 .clean-stage__carrier{height:1012px!important;}
  .clean-service-page #section1793182383 .clean-node-elem[data-clean-id="1767791730577"]{top:0!important;}
  .clean-service-page #section1793182383 .clean-node-elem:not([data-clean-id="1767791730577"]){transform:translate3d(0,-50px,0);}
}
...
.clean-modal--city{align-items:center;justify-content:center;padding:24px;}
.clean-modal--city .clean-modal__backdrop{background:rgba(49,49,49,.38);backdrop-filter:blur(2px);}
.clean-modal__panel--city{width:min(960px,calc(100vw - 80px));max-height:calc(100vh - 48px);overflow:auto;border-radius:20px;padding:34px 36px 40px;background:#faf9f6;box-shadow:0 10px 30px rgba(49,49,49,.06);transform:translateY(-12px);}
...
.clean-city-columns{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:22px;}
.clean-modal--city h2{margin:0 0 10px;font-family:var(--clean-headline-font);font-size:32px;font-weight:400;line-height:1.1;color:#313131;}
.clean-city-list{display:grid;gap:10px;}
.clean-city-list a{display:flex;align-items:center;justify-content:center;min-height:40px;padding:0 14px;border:1px solid #9e435a;border-radius:999px;color:#313131;background:#faf9f6;font-family:var(--clean-text-font);font-size:16px;font-weight:400;line-height:1.2;text-align:center;text-decoration:none;transition:background-color .2s ease,color .2s ease,border-color .2s ease;}
...
@media (max-width:960px){
  ...
  .clean-modal__panel--city{width:100%;max-height:calc(100vh - 32px);border-radius:20px;padding:28px 26px 32px;transform:none;}
  .clean-modal__close--city{right:20px;top:22px;font-size:44px;}
  .clean-city-columns{grid-template-columns:repeat(2,minmax(0,1fr));gap:22px 18px;}
  .clean-modal--city h2{font-size:32px;}
  .clean-city-list a{min-height:44px;font-size:14px;}
}
@media (max-width:479px){
  ...
  .clean-modal--city{padding:12px 10px;}
  .clean-modal__panel--city{border-radius:18px;padding:22px 12px 26px;}
  .clean-city-columns{grid-template-columns:repeat(2,minmax(0,1fr));gap:18px 12px;}
  .clean-modal--city h2{font-size:21px;margin-bottom:10px;}
  .clean-city-list{gap:10px;}
  .clean-city-list a{min-height:42px;padding:0 10px;font-size:13px;}
}
</style>`;
}
