...
function createAccountRenderers(deps = {}) {
  ...
  function renderCalendarPage(userContext, options = {}) {
    ...
    const dayOrders = assignedOrders.filter((item) => getAccountCalendarOrderDate(item) === calendarDate);
    const monthOrders = assignedOrders.filter((item) => getAccountCalendarOrderDate(item).startsWith(monthKey));
    ...
    return renderAccountLayout(
      ...
      `<div data-account-calendar-root>
        ...
        ${renderAccountMobileCalendar(assignedOrders, {
          staffId,
          staffRecord,
