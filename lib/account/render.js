...
function createAccountRenderers(deps = {}) {
  ...
  function renderAccountMobileStatusRow(item = {}, uiState = {}) {
    ...
    return `<div class="account-mobile-badge-row account-mobile-badge-row-with-action">
      ${badgeMarkup}
      <form class="account-mobile-inline-stage-form" method="post" action="${ACCOUNT_ROOT_PATH}" data-account-async-form="true">
        ...
        <button class="account-mobile-inline-stage-button" type="submit">${escapeHtml(uiState.nextAction.label)}</button>
      </form>
    </div>`;
  }
  ...
  function renderAccountAssignmentActionForms(item = {}, uiState = {}, options = {}) {
    ...
    } else if (canShowNextAction && !(options.mobile && shouldRenderCompactMobileStageAction(uiState))) {
      forms.push(`<form method="post" action="${ACCOUNT_ROOT_PATH}" data-account-async-form="true">
        <input type="hidden" name="action" value="${escapeHtmlAttribute(uiState.nextAction.action)}">
        <input type="hidden" name="entryId" value="${escapeHtmlAttribute(entryId)}">
  ...
  function renderAccountMobileDetailTopAction(item = {}, uiState = {}) {
    ...
    if (shouldRenderCompactMobileStageAction(uiState)) return "";
