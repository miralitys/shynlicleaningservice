...
function createAccountRenderers(deps = {}) {
  ...
  function renderAccountSidebar(userContext, activeKey = "dashboard", options = {}) {
    ...
    const sidebarLinks = [
      ...
      { key: "calendar", label: "Календарь", href: buildAccountSectionHref("calendar") },
  ...
  function renderAccountMobileDetailBottomNav(activeSection = "dashboard") {
    const navItems = [
      { key: "dashboard", label: "Заказы", href: buildAccountSectionHref("dashboard"), icon: "orders" },
      { key: "calendar", label: "Календарь", href: buildAccountSectionHref("calendar"), icon: "calendar" },
      { key: "payroll", label: "Заработок", href: buildAccountSectionHref("payroll"), icon: "payroll" },
    ];
