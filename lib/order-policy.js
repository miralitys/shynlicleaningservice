    ...
    <head>
      ...
      <style>
        ...
        * { box-sizing:border-box; }
        ...
        .grid { display:grid; grid-template-columns:1.15fr .85fr; gap:18px; padding:24px 36px 36px; }
        ...
        .copy { margin:0 0 20px; font-size:16px; line-height:1.7; color:var(--muted); }
        .summary-grid { display:grid; grid-template-columns:repeat(2, minmax(0, 1fr)); gap:12px; }
        .summary-item, .doc-card { border:1px solid var(--line); border-radius:20px; padding:16px 18px; background:#fafafa; }
        .summary-item-inline { grid-column:1 / -1; display:flex; align-items:center; gap:14px; padding:14px 18px; }
        ...
        .summary-value { font-size:18px; font-weight:700; line-height:1.35; }
        .summary-item-inline .summary-label { margin:0; flex:0 0 auto; }
        .summary-item-inline .summary-value { min-width:0; flex:1 1 auto; font-size:16px; line-height:1.3; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
