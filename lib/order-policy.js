...
const POLICY_ACCEPTANCE_CERTIFICATE_GENERATOR_VERSION = "2026-04-14-template-v2";
...
async function generatePolicyAcceptanceCertificate(record) {
  ...
  let usingTemplateBackground = false;
  if (templateBytes) {
    const templateImage =
