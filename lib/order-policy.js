    ...
    .map((doc) => {
      ...
      return `<article class="doc-card">
        <div class="doc-topline">
          ...
          <a class="doc-link" href="${escapeHtmlAttribute(publicUrl)}" target="_blank" rel="noreferrer">${escapeHtml(
            buttonLabel
          )}</a>
        </div>
    ...
    <head>
      ...
      <style>
        ...
        * { box-sizing:border-box; }
        ...
        .summary-item { border:1px solid var(--line); border-radius:18px; padding:14px 16px; background:#fafafa; min-height:102px; }
        ...
        .doc-topline { display:flex; align-items:center; justify-content:space-between; gap:12px; }
        .doc-topline .doc-label { margin:0; }
        .doc-title { margin:6px 0 0; font-size:16px; font-weight:700; line-height:1.3; }
        .doc-link { color:var(--accent); text-decoration:none; font-size:13px; font-weight:700; white-space:nowrap; }
        .doc-url {
          display:block;
          margin-top:4px;
          font-size:13px;
            ...
            docList.innerHTML = docs.map(function(doc) {
              ...
              return '<article class="doc-card">' +
                '<div class="doc-topline">' +
                  ...
                  '<a class="doc-link" href="' + doc.publicUrl + '" target="_blank" rel="noreferrer">' + buttonLabel + '</a>' +
                '</div>' +
