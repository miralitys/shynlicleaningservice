...
const {
  buildPublicPolicyPayload: buildPublicPolicyPayloadImpl,
} = require("./order-policy/public-payload");
const {
...
} = require("./order-policy/admin-service");
const {
  createOrderPolicyAcceptancePublicService,
} = require("./order-policy/public-service");
const {
  createOrderPolicyAcceptanceSharedService,
} = require("./order-policy/shared-service");
...
function buildPublicPolicyPayload(entry, record, options = {}) {
  ...
  return buildPublicPolicyPayloadImpl(customerSummary, record, {
    ...
    apiBasePath: POLICY_ACCEPTANCE_API_BASE_PATH,
  });
}
