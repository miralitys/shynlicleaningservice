...
const POLICY_ACCEPTANCE_CERTIFICATE_GENERATOR_VERSION = "2026-04-14-template-v3";
...
async function generatePolicyAcceptanceCertificate(record) {
  ...
  if (templateBytes) {
    ...
    drawTemplateText(formatChicagoDateTime(completedAt), 1286, 340, 310, {
      size: 8.9,
      minSize: 6.8,
      align: "left",
    });
    ...
    drawTemplateText(formatChicagoDateTime(sanitized.sentAt), 985, 658, 610, {
      size: 8.5,
      minSize: 6.2,
    });
    drawTemplateText(
    ...
    drawTemplateText(formatChicagoDateTime(sanitized.signedAt), 985, 890, 610, {
      size: 8.5,
      minSize: 6.2,
    });
    ...
    clearTemplateRect(238, 1684, 1384, 192);
    drawTemplateWrappedText(buildAcceptanceStatement(sanitized), 252, 1760, 1342, {
      size: 8,
      lineHeight: 9.2,
      maxLines: 7,
      maxLength: 2000,
    ...
    clearTemplateRect(588, 2049, 344, 52);
    clearTemplateRect(1004, 2049, 605, 52);
    drawTemplateText(sanitized.typedSignature || "Not set", 603, 2087, 310, {
      size: 7.8,
      minSize: 6,
      maxLength: 220,
    });
