    ...
    .map((doc) => {
      ...
      return `<article class="doc-card">
        <div class="doc-topline">
          ...
          <a class="doc-link" href="${escapeHtmlAttribute(publicUrl)}" target="_blank" rel="noreferrer">Open document</a>
        </div>
            ...
            docList.innerHTML = docs.map(function(doc) {
              return '<article class="doc-card">' +
                '<div class="doc-topline">' +
                  ...
                  '<a class="doc-link" href="' + doc.publicUrl + '" target="_blank" rel="noreferrer">Open document</a>' +
                '</div>' +
