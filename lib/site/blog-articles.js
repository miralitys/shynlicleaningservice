...
const BLOG_ARTICLES = Object.freeze([
  {
...
<section class="shynli-blog-article__hero-visual" aria-label="Weekly cleaning illustration for a 3 bedroom house">
  <div class="shynli-blog-article__hero-visual-shell">
    <div class="shynli-blog-article__hero-visual-copy">
      <p class="shynli-blog-article__hero-visual-eyebrow">Weekly reset visual</p>
      <h2 class="shynli-blog-article__hero-visual-title">One weekly system for a lived-in 3 bedroom house.</h2>
      <p class="shynli-blog-article__hero-visual-text">Think in zones, not chaos: three bedrooms reset, bathrooms restored, kitchen and living spaces edited, then floors and finishing details to close the week cleanly.</p>
      <div class="shynli-blog-article__hero-visual-stats" aria-hidden="true">
        <span class="shynli-blog-article__hero-visual-stat"><strong>3</strong> bedrooms</span>
        <span class="shynli-blog-article__hero-visual-stat"><strong>4</strong> core zones</span>
        <span class="shynli-blog-article__hero-visual-stat"><strong>1</strong> weekly baseline</span>
      </div>
    </div>
    <div class="shynli-blog-article__hero-visual-board">
      <div class="shynli-blog-article__hero-visual-plan" aria-hidden="true">
        <article class="shynli-blog-article__hero-room">
          <p class="shynli-blog-article__hero-room-label">Bedroom 1</p>
          <ul>
            <li>Linens</li>
            <li>Dust</li>
            <li>Vacuum</li>
        ...
        <article class="shynli-blog-article__hero-room">
          <p class="shynli-blog-article__hero-room-label">Bedroom 2</p>
          <ul>
            <li>Reset</li>
            <li>Surfaces</li>
            <li>Floors</li>
        ...
        <article class="shynli-blog-article__hero-room">
          <p class="shynli-blog-article__hero-room-label">Bedroom 3</p>
          <ul>
            <li>Tidy</li>
            <li>Dust</li>
            <li>Vacuum</li>
        ...
        <article class="shynli-blog-article__hero-room is-accent">
          <p class="shynli-blog-article__hero-room-label">Bathrooms</p>
          <ul>
            <li>Toilets</li>
            <li>Mirrors</li>
            <li>Mop</li>
        ...
        <article class="shynli-blog-article__hero-room is-wide">
          <p class="shynli-blog-article__hero-room-label">Kitchen + Living</p>
          <ul>
            <li>Counters</li>
            <li>Dusting</li>
            <li>Entry reset</li>
        ...
        <article class="shynli-blog-article__hero-room is-accent">
          <p class="shynli-blog-article__hero-room-label">Floors</p>
          <ul>
            <li>Vacuum</li>
            <li>Mop</li>
            <li>Final pass</li>
      ...
      <div class="shynli-blog-article__hero-visual-note">
        <span class="shynli-blog-article__hero-visual-note-dot" aria-hidden="true"></span>
        Weekly cleaning works best when the rooms are grouped into one repeatable pattern instead of one giant undefined task.
      </div>
    </div>
  </div>
</section>
