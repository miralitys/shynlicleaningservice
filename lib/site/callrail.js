...
const CALLRAIL_SWAP_SCRIPT_SRC = "/js/vendor/callrail-swap.20260522.js";
...
function stripCallRailSwapScript(html) {
  return String(html || "").replace(
    /<script\b[^>]*\bsrc=["']?(?:(?:https?:)?\/\/cdn\.callrail\.com\/companies\/562095680\/7c306f50357be4c201eb\/12\/swap\.js|\/js\/vendor\/callrail-swap\.[a-f0-9]{8,}\.js)["']?[^>]*>\s*<\/script>/gi,
    ""
  );
}
