...
function buildBlogHubStyles() {
  return `<style>#blog-topics-hub{padding:26px 0 54px;background:#faf9f6;}#blog-topics-hub .shynli-blog-hub__shell{width:min(1180px,calc(100% - 32px));margin:0 auto;display:grid;gap:28px;}#blog-topics-hub .shynli-blog-hub__intro{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(280px,.8fr);gap:22px;align-items:end;}#blog-topics-hub .shynli-blog-hub__eyebrow{margin:0 0 10px;color:#9e445a;font-family:'Montserrat',Arial,sans-serif;font-size:13px;line-height:1.2;font-weight:700;letter-spacing:.18em;text-transform:uppercase;}#blog-topics-hub .shynli-blog-hub__title{margin:0;color:#313131;font-family:'Playfair Display',serif;font-size:56px;line-height:1.02;font-weight:400;max-width:720px;}#blog-topics-hub .shynli-blog-hub__text{margin:16px 0 0;max-width:760px;color:#5f5954;font-family:'Montserrat',Arial,sans-serif;font-size:17px;line-height:1.7;font-weight:400;}#blog-topics-hub .shynli-blog-hub__note{padding:22px 24px;border:1px solid rgba(158,68,90,.18);border-radius:22px;background:rgba(232,225,217,.55);color:#4c4641;font-family:'Montserrat',Arial,sans-serif;font-size:15px;line-height:1.7;font-weight:400;}#blog-topics-hub .shynli-blog-hub__intent-label{margin:0 0 10px;color:#313131;font-family:'Montserrat',Arial,sans-serif;font-size:13px;line-height:1.2;font-weight:700;letter-spacing:.14em;text-transform:uppercase;}#blog-topics-hub .shynli-blog-hub__intent-list{margin:0;padding:0;list-style:none;display:grid;gap:10px;}#blog-topics-hub .shynli-blog-hub__intent-item{display:grid;grid-template-columns:12px minmax(0,1fr);gap:10px;align-items:start;color:#4c4641;font-family:'Montserrat',Arial,sans-serif;font-size:15px;line-height:1.65;font-weight:400;}#blog-topics-hub .shynli-blog-hub__intent-bullet{color:#9e445a;font-weight:700;line-height:1.5;}#blog-topics-hub .shynli-blog-hub__grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;}#blog-topics-hub .shynli-blog-topic{appearance:none;border:1px solid rgba(158,68,90,.14);border-radius:22px;padding:20px 20px 18px;background:#f3ece4;color:#313131;text-align:left;cursor:pointer;display:flex;flex-direction:column;gap:10px;transition:transform .2s ease,box-shadow .2s ease,border-color .2s ease,background-color .2s ease;text-decoration:none;box-sizing:border-box;}#blog-topics-hub .shynli-blog-topic:hover,#blog-topics-hub .shynli-blog-topic:focus-visible,#blog-topics-hub .shynli-blog-topic.is-current{transform:translateY(-2px);border-color:#9e445a;background:#fff;box-shadow:0 18px 34px rgba(49,49,49,.08);outline:none;}#blog-topics-hub .shynli-blog-topic__name{display:block;color:#1f1f1f;font-family:'Playfair Display',serif;font-size:28px;line-height:1.08;font-weight:400;}#blog-topics-hub .shynli-blog-topic__copy{display:block;color:#66605a;font-family:'Montserrat',Arial,sans-serif;font-size:14px;line-height:1.65;font-weight:400;}#blog-topics-hub .shynli-blog-topic.is-current .shynli-blog-topic__name{color:#9e445a;}#blog-topics-hub .shynli-blog-quote-panel{display:grid;grid-template-columns:minmax(0,1fr) minmax(320px,420px);gap:26px;align-items:center;padding:30px;border-radius:28px;background:#313131;color:#faf9f6;overflow:hidden;}#blog-topics-hub .shynli-blog-quote-panel__eyebrow{margin:0 0 10px;color:#d8cfc4;font-family:'Montserrat',Arial,sans-serif;font-size:13px;line-height:1.2;font-weight:700;letter-spacing:.18em;text-transform:uppercase;}#blog-topics-hub .shynli-blog-quote-panel__title{margin:0;color:#faf9f6;font-family:'Playfair Display',serif;font-size:40px;line-height:1.04;font-weight:400;max-width:520px;}#blog-topics-hub .shynli-blog-quote-panel__text{margin:14px 0 0;color:rgba(250,249,246,.78);font-family:'Montserrat',Arial,sans-serif;font-size:16px;line-height:1.7;font-weight:400;max-width:560px;}#blog-topics-hub .shynli-blog-quote-form{display:grid;gap:12px;padding:22px;border-radius:24px;background:rgba(250,249,246,.08);backdrop-filter:blur(8px);}#blog-topics-hub .shynli-blog-quote-form>*{min-width:0;}#blog-topics-hub .shynli-blog-quote-label{display:block;margin:0 0 6px;color:#faf9f6;font-family:'Montserrat',Arial,sans-serif;font-size:13px;line-height:1.4;font-weight:600;}#blog-topics-hub .shynli-blog-quote-input{width:100%;box-sizing:border-box;border:1px solid rgba(255,255,255,.15);border-radius:16px;padding:14px 16px;background:#faf9f6;color:#313131;font-family:'Montserrat',Arial,sans-serif;font-size:16px;line-height:1.4;}#blog-topics-hub .shynli-blog-quote-input:focus{outline:none;border-color:#9e445a;box-shadow:0 0 0 3px rgba(158,68,90,.18);}#blog-topics-hub .shynli-blog-quote-button{display:flex;align-items:center;justify-content:center;width:100%;min-height:68px;margin:0;padding:18px 24px;border:none;border-radius:999px;background:#9e445a;color:#fff;font-family:'Montserrat',Arial,sans-serif;font-size:15px;line-height:1;font-weight:700;cursor:pointer;transition:background-color .2s ease,transform .2s ease;box-sizing:border-box;appearance:none;-webkit-appearance:none;text-align:center;}#blog-topics-hub .shynli-blog-quote-button:hover,#blog-topics-hub .shynli-blog-quote-button:focus-visible{background:#83384c;transform:translateY(-1px);outline:none;}#blog-topics-hub .shynli-blog-quote-hint{margin:0;color:rgba(250,249,246,.68);font-family:'Montserrat',Arial,sans-serif;font-size:12px;line-height:1.55;font-weight:400;}#blog-topics-hub .shynli-blog-quote-hint a{color:inherit;text-decoration:underline;}.shynli-blog-popup-cta{margin-top:28px;padding-top:24px;border-top:1px solid rgba(49,49,49,.12);}.shynli-blog-popup-cta .shynli-blog-quote-panel{display:grid;grid-template-columns:1fr;gap:18px;padding:24px;border-radius:24px;background:#efe7de;color:#313131;box-shadow:0 14px 30px rgba(49,49,49,.06);}.shynli-blog-popup-cta .shynli-blog-quote-panel__eyebrow{margin:0 0 8px;color:#9e445a;font-family:'Montserrat',Arial,sans-serif;font-size:12px;line-height:1.2;font-weight:700;letter-spacing:.16em;text-transform:uppercase;}.shynli-blog-popup-cta .shynli-blog-quote-panel__title{margin:0;color:#313131;font-family:'Playfair Display',serif;font-size:32px;line-height:1.06;font-weight:400;}.shynli-blog-popup-cta .shynli-blog-quote-panel__text{margin:12px 0 0;color:#5f5954;font-family:'Montserrat',Arial,sans-serif;font-size:15px;line-height:1.65;font-weight:400;}.shynli-blog-popup-cta .shynli-blog-quote-form{display:grid;gap:12px;padding:0;background:transparent;}.shynli-blog-popup-cta .shynli-blog-quote-form>*{min-width:0;}.shynli-blog-popup-cta .shynli-blog-quote-label{display:block;margin:0 0 6px;color:#313131;font-family:'Montserrat',Arial,sans-serif;font-size:13px;line-height:1.4;font-weight:600;}.shynli-blog-popup-cta .shynli-blog-quote-input{width:100%;box-sizing:border-box;border:1px solid rgba(49,49,49,.12);border-radius:16px;padding:14px 16px;background:#fff;color:#313131;font-family:'Montserrat',Arial,sans-serif;font-size:16px;line-height:1.4;}.shynli-blog-popup-cta .shynli-blog-quote-input:focus{outline:none;border-color:#9e445a;box-shadow:0 0 0 3px rgba(158,68,90,.16);}.shynli-blog-popup-cta .shynli-blog-quote-button{display:flex;align-items:center;justify-content:center;width:100%;min-height:68px;margin:0;padding:18px 24px;border:none;border-radius:999px;background:#9e445a;color:#fff;font-family:'Montserrat',Arial,sans-serif;font-size:15px;line-height:1;font-weight:700;cursor:pointer;box-sizing:border-box;appearance:none;-webkit-appearance:none;text-align:center;}.shynli-blog-popup-cta .shynli-blog-quote-hint{margin:0;color:#6b645e;font-family:'Montserrat',Arial,sans-serif;font-size:12px;line-height:1.55;font-weight:400;}.shynli-blog-popup-cta .shynli-blog-quote-hint a{color:inherit;text-decoration:underline;}@media screen and (max-width:1199px){#blog-topics-hub .shynli-blog-hub__title{font-size:50px;}#blog-topics-hub .shynli-blog-topic__name{font-size:26px;}#blog-topics-hub .shynli-blog-quote-panel__title{font-size:36px;}}@media screen and (max-width:959px){#blog-topics-hub{padding:18px 0 42px;}#blog-topics-hub .shynli-blog-hub__intro{grid-template-columns:1fr;}#blog-topics-hub .shynli-blog-hub__title{font-size:42px;max-width:none;}#blog-topics-hub .shynli-blog-hub__grid{grid-template-columns:repeat(2,minmax(0,1fr));}#blog-topics-hub .shynli-blog-quote-panel{grid-template-columns:1fr;}}@media screen and (max-width:639px){#blog-topics-hub .shynli-blog-hub__shell{width:min(100% - 24px,1180px);}#blog-topics-hub .shynli-blog-hub__title{font-size:34px;}#blog-topics-hub .shynli-blog-hub__text{font-size:15px;}#blog-topics-hub .shynli-blog-hub__grid{grid-template-columns:1fr;}#blog-topics-hub .shynli-blog-topic{padding:18px 18px 16px;border-radius:20px;}#blog-topics-hub .shynli-blog-topic__name{font-size:25px;}#blog-topics-hub .shynli-blog-quote-panel{padding:22px;border-radius:24px;}#blog-topics-hub .shynli-blog-quote-panel__title,.shynli-blog-popup-cta .shynli-blog-quote-panel__title{font-size:28px;}#blog-topics-hub .shynli-blog-quote-form,.shynli-blog-popup-cta .shynli-blog-quote-form{padding:0;}} </style>`;
}
...
function buildCategoryBlogHubSection(detail) {
  return `<section id="blog-topics-hub" class="shynli-blog-hub shynli-blog-hub--category">${buildBlogHubStyles()}<div class="shynli-blog-hub__shell"><div class="shynli-blog-hub__intro"><div><p class="shynli-blog-hub__eyebrow">Blog category</p><h2 class="shynli-blog-hub__title">${escapeBlogHtml(
    ...
    detail
  )}</ul></div></div><div class="shynli-blog-hub__grid">${buildBlogTopicCards(
    detail.path
...
function buildBlogHubSection(routePath) {
  ...
  const detail = BLOG_CATEGORY_DETAILS.find((item) => item.path === normalizedRoute);
...
function buildBlogRuntimeScript(routePath) {
  const normalizedRoute = normalizeRoute(routePath);
  const detail = BLOG_CATEGORY_DETAILS.find((item) => item.path === normalizedRoute) || null;
  const currentCategory = detail
    ? {
        label: detail.label,
        aliases: detail.filterAliases,
      }
    : null;

  return `<script id="shynli-blog-topic-hub-script">(function(){if(window.__shynliBlogHubInit)return;window.__shynliBlogHubInit=true;var CURRENT_CATEGORY=${JSON.stringify(
    currentCategory
  )};function formatPhone(digits){if(!digits)return'';if(digits.length<=3)return '('+digits;if(digits.length<=6)return '('+digits.slice(0,3)+') '+digits.slice(3);return '('+digits.slice(0,3)+') '+digits.slice(3,6)+'-'+digits.slice(6,10);}function bindQuoteForm(form){if(!form||form.dataset.bound==='1')return;var nameInput=form.querySelector('input[name=\"name\"]');var phoneInput=form.querySelector('input[name=\"phone\"]');if(!nameInput||!phoneInput)return;form.dataset.bound='1';phoneInput.addEventListener('input',function(event){var digits=String(event.target.value||'').replace(/\\D/g,'');if(digits.startsWith('1')&&digits.length===11)digits=digits.slice(1);if(digits.length>10)digits=digits.slice(0,10);event.target.value=formatPhone(digits);});phoneInput.addEventListener('keydown',function(event){var digits=String(phoneInput.value||'').replace(/\\D/g,'');if(digits.startsWith('1')&&digits.length===11)digits=digits.slice(1);if(digits.length>=10&&event.key!=='Backspace'&&event.key!=='Delete'&&!event.ctrlKey&&!event.metaKey&&!event.key.startsWith('Arrow')&&event.key!=='Tab'){event.preventDefault();}});form.addEventListener('submit',function(event){event.preventDefault();var name=(nameInput.value||'').trim();var phone=(phoneInput.value||'').trim();if(!name||!phone){window.alert('Please fill in all fields');return;}var phoneDigits=phone.replace(/\\D/g,'');if(phoneDigits.startsWith('1')&&phoneDigits.length===11)phoneDigits=phoneDigits.slice(1);if(phoneDigits.length!==10){window.alert('Please enter a valid 10-digit phone number');return;}var formattedPhone='+1 '+phoneInput.value;try{sessionStorage.setItem('homeWidgetName',name);sessionStorage.setItem('homeWidgetPhone',formattedPhone);}catch(error){}var quoteParams=new URLSearchParams({name:name,phone:formattedPhone});window.location.href='/quote?'+quoteParams.toString();});}function initQuoteForms(root){Array.prototype.slice.call((root||document).querySelectorAll('[data-blog-quote-form]')).forEach(bindQuoteForm);}function buildPopupCtaMarkup(){return ['<section class=\"shynli-blog-popup-cta\">','<div class=\"shynli-blog-quote-panel\">','<div class=\"shynli-blog-quote-panel__copy\">','<p class=\"shynli-blog-quote-panel__eyebrow\">Need help instead?</p>','<h3 class=\"shynli-blog-quote-panel__title\">Get a cleaning quote while this guide is fresh.</h3>','<p class=\"shynli-blog-quote-panel__text\">Leave your name and phone, and continue to the quote flow in one step with your details prefilled.</p>','</div>','<form class=\"shynli-blog-quote-form\" data-blog-quote-form>','<div><label class=\"shynli-blog-quote-label\">Your name<input class=\"shynli-blog-quote-input\" type=\"text\" name=\"name\" autocomplete=\"name\" placeholder=\"Enter your name\" required></label></div>','<div><label class=\"shynli-blog-quote-label\">Phone number<input class=\"shynli-blog-quote-input\" type=\"tel\" name=\"phone\" autocomplete=\"tel\" placeholder=\"(000) 000-0000\" inputmode=\"tel\" maxlength=\"14\" required></label></div>','<button class=\"shynli-blog-quote-button\" type=\"submit\">Continue to quote</button>','<p class=\"shynli-blog-quote-hint\">By submitting, you agree to our <a href=\"/terms-of-service\">Terms of Service</a>.</p>','</form>','</div>','</section>'].join('');}function injectPopupCtas(root){Array.prototype.slice.call((root||document).querySelectorAll('.t-popup')).forEach(function(popup){var hasFeedContent=popup.querySelector('.t-feed__post-popup, .t-feed__post-popup__textwrapper, .t-feed__post-popup__content, [class*=\"t-feed__post-popup\"]');if(!hasFeedContent)return;var target=popup.querySelector('.t-feed__post-popup__content, .t-feed__post-popup__textwrapper, .t-feed__post-popup__all-text-wrapper, .t-feed__post-popup__descr, .t-feed__post-popup')||popup.querySelector('.t-popup__container');if(!target||target.querySelector('.shynli-blog-popup-cta'))return;target.insertAdjacentHTML('beforeend',buildPopupCtaMarkup());initQuoteForms(target);});}function normalizeText(value){return String(value||'').toLowerCase().replace(/&/g,' and ').replace(/[’']/g,'').replace(/[^a-z0-9]+/g,' ').trim();}function activateFeedFilter(attempt){if(!CURRENT_CATEGORY)return;var buttons=Array.prototype.slice.call(document.querySelectorAll('.t-feed__parts-switch-btn'));if(!buttons.length){if((attempt||0)<10)setTimeout(function(){activateFeedFilter((attempt||0)+1);},300);return;}var aliases=(CURRENT_CATEGORY.aliases||[CURRENT_CATEGORY.label]).map(normalizeText).filter(Boolean);var activated=false;buttons.forEach(function(button){var text=normalizeText(button.textContent||'');if(!text)return;var matches=aliases.some(function(alias){return text===alias||text.indexOf(alias)!==-1||alias.indexOf(text)!==-1;});if(!matches)return;var target=button.querySelector('button, a')||button;if(button.classList.contains('t-active')){activated=true;return;}if(typeof target.click==='function')target.click();activated=true;});if(!activated&&(attempt||0)<10)setTimeout(function(){activateFeedFilter((attempt||0)+1);},300);}function boot(){initQuoteForms(document);injectPopupCtas(document);activateFeedFilter(0);}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',boot,{once:true});}else{boot();}if(window.MutationObserver&&document.body){var observer=new MutationObserver(function(){injectPopupCtas(document);initQuoteForms(document);if(CURRENT_CATEGORY)activateFeedFilter(0);});observer.observe(document.body,{childList:true,subtree:true});}})();</script>`;
}

function rebuildBlogHubSection(html, routePath) {
  const normalizedRoute = normalizeRoute(routePath);
  if (normalizedRoute !== BLOG_ROUTE && !BLOG_CATEGORY_DETAILS.some((detail) => detail.path === normalizedRoute)) {
    return html;
  }
