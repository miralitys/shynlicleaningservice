...
function customizeQuoteNoPriceForm(html, routePath) {
  const normalizedRoute = normalizeRoute(routePath);
...
function sanitizeHtml(html, routePath = "/") {
  ...
  cleaned = customizeQuoteNoPriceForm(cleaned, normalizedRoute);
  ...
  if ((normalizedRoute === "/quote-no-price" || normalizedRoute === "/quote-no-calculator") && !cleaned.includes('id="quote-no-price-runtime"')) {
