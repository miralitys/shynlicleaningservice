...
function customizeAdsHomepageHero(html, routePath) {
  ...
  let output = String(html || "")
    .replace(
      ...
      'Professional Home Cleaning in Chicagoland. <span class="shynli-ads-hero-highlight"><span class="shynli-ads-price-pair">From $<span class="shynli-ads-price-old">200</span> <span class="shynli-ads-price-new">$135</span></span> &middot; Same-Day Available &middot; Pay After Done</span>'
    )
    .replace(
