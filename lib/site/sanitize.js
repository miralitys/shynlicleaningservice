...
.shynli-blog-shell__submenu{
  ...
  padding:14px;
  border-radius:20px;
  border:1px solid rgba(158,68,90,.14);
  background:#ffffff;
...
.shynli-blog-shell__submenu a:focus-visible{
  background:var(--shynli-shell-surface-alt);
  color:var(--shynli-shell-accent);
  outline:none;
}
...
.shynli-blog-shell__button{
  ...
  padding:0 20px;
  border-radius:999px;
  border:1px solid rgba(158,68,90,.16);
  background:#ffffff;
  color:var(--shynli-shell-ink);
  font-size:14px;
  line-height:1;
