...
#blog-topics-hub .shynli-blog-article__hero-illustration{display:grid;gap:12px;margin:0;padding:0;}
#blog-topics-hub .shynli-blog-article__hero-illustration-image{display:block;width:100%;height:auto;border-radius:28px;border:1px solid rgba(158,68,90,.14);background:linear-gradient(145deg,#fff8f3 0%,#f1e7dc 100%);box-shadow:0 22px 44px rgba(49,49,49,.08);}
#blog-topics-hub .shynli-blog-article__hero-illustration-caption{margin:0;color:#6c645e;font-family:'Montserrat',Arial,sans-serif;font-size:13px;line-height:1.65;font-weight:500;text-align:center;}
...
@media screen and (max-width:639px){
  ...
  #blog-topics-hub .shynli-blog-article__hero-illustration-image{border-radius:22px;}
