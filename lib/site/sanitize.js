...
.ads2-review-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px;}
.ads2-review{padding:22px;border:1px solid rgba(158,67,90,.12);border-radius:8px;background:#fffdfb;}
...
const ADS_V2_REVIEWS = [
  ["Nice clean job! Thank you.", "Suganya Swamy", "Google Review"],
  ["Excellent service from start to finish. The cleaners were on time, friendly, and very detail-oriented.", "Max Krasavin", "Home Cleaning"],
  ["I booked a move-out cleaning and they did an amazing job. The team arrived on time and left the place spotless.", "Mobile Legends Jek", "Move Out Cleaning"],
];
...
function buildAdsV2LandingPage() {
  ...
  <section class="ads2-section" aria-labelledby="ads2-reviews-title">
    <div class="ads2-shell">
      ...
      <div class="ads2-review-grid">${buildAdsV2Reviews()}</div>
    </div>
  </section>
