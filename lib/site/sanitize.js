...
const BLOG_SHELL_CITY_LINKS = Object.freeze([
...
.shynli-blog-shell__details--city[open] .shynli-blog-shell__button-summary{
  background:var(--shynli-shell-accent);
  border-color:var(--shynli-shell-accent);
  color:#ffffff;
}
.shynli-blog-shell__details--city[open] .shynli-blog-shell__button-summary:hover,
.shynli-blog-shell__details--city[open] .shynli-blog-shell__button-summary:focus-visible{
  background:var(--shynli-shell-accent-dark);
  border-color:var(--shynli-shell-accent-dark);
  color:#ffffff;
}
.shynli-blog-shell__submenu--city{
  top:calc(100% + 14px);
  left:auto;
  right:0;
...
.shynli-blog-shell__submenu--city::before{
  top:-11px;
  width:22px;
  height:22px;
  right:86px;
...
.shynli-blog-shell__submenu--city .shynli-blog-shell__submenu-title{
  padding:0 38px 24px;
  font-size:16px;
  letter-spacing:.14em;
}
.shynli-blog-shell__submenu--city .shynli-blog-shell__city-grid{
  padding:0 38px 18px;
  gap:0 56px;
}
.shynli-blog-shell__submenu--city .shynli-blog-shell__city-grid a{
  padding:0 0 26px;
  font-size:18px;
  line-height:1.35;
}
.shynli-blog-shell__submenu--city .shynli-blog-shell__submenu-cta{
  margin-top:0;
  padding:24px 38px 28px !important;
  border-top:1px solid rgba(158,68,90,.16);
  font-size:18px;
  line-height:1.3;
}
