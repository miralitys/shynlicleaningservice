...
.shynli-ads-hero-highlight{color:#9e435a;}
...
@media (max-width:640px){.shynli-ads-hero-offer{gap:8px;justify-content:center;font-size:13px;line-height:1.25;}.shynli-ads-countdown{min-width:58px;padding:6px 10px;}.shynli-ads-countdown-button{min-height:30px;padding:0 12px;font-size:11px;}}
</style>`;
