...
.shynli-site-footer{margin:0;padding:62px 0 34px;background:#313131;color:#d8cfc4;font-family:"Montserrat",Arial,sans-serif;}
.shynli-site-footer__shell{width:min(1640px,calc(100% - 96px));margin:0 auto;}
.shynli-site-footer__top{display:grid;grid-template-columns:minmax(230px,340px) minmax(180px,1fr) minmax(160px,.9fr) minmax(190px,1fr);gap:42px 88px;align-items:start;}
.shynli-site-footer__brand{display:grid;gap:18px;}
.shynli-site-footer__logo{display:inline-flex;align-items:center;width:max-content;max-width:100%;text-decoration:none;}
.shynli-site-footer__logo img{display:block;width:232px;max-width:100%;height:auto;}
.shynli-site-footer__tagline,.shynli-site-footer__copy{margin:0;color:#b9b4ae;font-size:18px;line-height:1.58;font-weight:400;}
.shynli-site-footer__copy{max-width:285px;margin-top:12px;}
.shynli-site-footer__title{margin:0 0 18px;color:#f6f1ea;font-family:"Playfair Display",Georgia,serif;font-size:34px;line-height:1.08;font-weight:500;}
.shynli-site-footer__links{display:grid;gap:15px;}
.shynli-site-footer__links a{display:block;width:max-content;max-width:100%;color:#cfc8bf;font-size:18px;line-height:1.35;font-weight:500;text-decoration:none;}
...
.shynli-site-footer__bottom{display:flex;align-items:center;justify-content:space-between;gap:28px;margin-top:44px;padding-top:28px;border-top:1px solid rgba(216,207,196,.16);color:#b9b4ae;font-size:15px;line-height:1.6;font-weight:500;}
.shynli-site-footer__bottom p{margin:0;}
@media screen and (max-width:1199px){
  .shynli-site-footer__shell{width:min(1180px,calc(100% - 48px));}
  .shynli-site-footer__top{grid-template-columns:repeat(2,minmax(0,1fr));gap:38px 56px;}
}
@media screen and (max-width:639px){
  .shynli-site-footer{padding:42px 0 30px;}
  .shynli-site-footer__shell{width:min(1180px,calc(100% - 28px));}
  .shynli-site-footer__top{grid-template-columns:1fr;gap:30px;}
  .shynli-site-footer__logo img{width:202px;}
  .shynli-site-footer__tagline,.shynli-site-footer__copy,.shynli-site-footer__links a{font-size:16px;}
  .shynli-site-footer__copy{max-width:320px;margin-top:2px;}
  .shynli-site-footer__title{font-size:28px;margin-bottom:14px;}
  .shynli-site-footer__links{gap:12px;}
  .shynli-site-footer__bottom{display:grid;gap:12px;margin-top:34px;padding-top:22px;font-size:13px;}
}
@media print{
