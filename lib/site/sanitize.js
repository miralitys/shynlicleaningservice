...
body.shynli-deep-cleaning-ads-page .shynli-deep-ads-trust-strip{background:var(--dc-cream);padding:20px 0 32px;font-family:"Montserrat",Arial,sans-serif;}
...
body.shynli-deep-cleaning-ads-page .shynli-deep-ads-trust-strip__item{display:grid;grid-template-columns:34px minmax(0,1fr);gap:5px 10px;align-items:start;min-height:84px;padding:16px;border:1px solid rgba(158,67,90,.14);border-radius:8px;background:var(--dc-soft-panel);color:var(--dc-ink);box-shadow:0 14px 34px rgba(71,47,42,.04);font-size:14px;font-weight:800;line-height:1.25;}
body.shynli-deep-cleaning-ads-page .shynli-deep-ads-trust-strip__icon{display:flex;align-items:center;justify-content:center;width:30px;height:30px;border-radius:50%;background:var(--dc-rose);color:#fff;font-size:14px;font-weight:900;line-height:1;grid-row:1/2;}
...
@media screen and (max-width:959px){
  ...
  body.shynli-deep-cleaning-ads-page .shynli-deep-ads-trust-strip__item{min-height:78px;padding:13px;grid-template-columns:28px minmax(0,1fr);gap:4px 8px;font-size:12px;}
  body.shynli-deep-cleaning-ads-page .shynli-deep-ads-trust-strip__icon{width:26px;height:26px;font-size:12px;}
