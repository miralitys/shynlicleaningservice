...
function buildHomepageClientSayCard(review) {
  const initial = String(review.name || "S").trim().charAt(0).toUpperCase() || "S";
  return `<article class="clients-say-home__card"><div class="clients-say-home__stars" aria-label="5 out of 5 stars">★★★★★</div><p class="clients-say-home__text">${escapeHtml(
    review.text
...
function buildHomepageClientsSaySection() {
  const rowsMarkup = HOMEPAGE_CLIENTS_SAY_ROWS.map(
    (row, index) =>
      `<div class="clients-say-home__rail clients-say-home__rail--${index === 0 ? "top" : "bottom"}"><div class="clients-say-home__track clients-say-home__track--${
        index === 0 ? "top" : "bottom"
      }">${row.map(buildHomepageClientSayCard).join("")}</div></div>`
  ).join("");
...
.clients-say-home{background:#faf9f6;padding:10px 0 24px;overflow:hidden;}
.clients-say-home__inner{max-width:1360px;margin:0 auto;}
.clients-say-home__heading{margin:0 0 14px;text-align:center;color:#313131;font-size:42px;line-height:1.06;font-weight:400;font-family:var(--t-headline-font,Georgia,serif);}
.clients-say-home__heading span{color:#9e435a;}
.clients-say-home__stack{display:flex;flex-direction:column;gap:14px;}
.clients-say-home__rail{position:relative;overflow-x:auto;overflow-y:hidden;padding:2px 20px;scroll-snap-type:x proximity;-webkit-overflow-scrolling:touch;scrollbar-width:none;}
.clients-say-home__rail::-webkit-scrollbar{display:none;}
.clients-say-home__track{display:flex;gap:14px;width:max-content;}
.clients-say-home__track--bottom{padding-left:136px;}
.clients-say-home__card{scroll-snap-align:start;width:258px;min-height:168px;background:#fff;border-radius:20px;padding:16px 18px 15px;box-shadow:0 16px 34px rgba(49,49,49,.045);display:flex;flex-direction:column;justify-content:space-between;}
...
@media (max-width:1199px){.clients-say-home__heading{font-size:36px;}.clients-say-home__card{width:238px;min-height:160px;padding:15px 16px 14px;}.clients-say-home__text{font-size:15.5px;}}
@media (max-width:959px){.clients-say-home{padding:8px 0 20px;}.clients-say-home__heading{font-size:32px;}.clients-say-home__card{width:220px;min-height:154px;}.clients-say-home__text{font-size:15.5px;}.clients-say-home__track--bottom{padding-left:88px;}}
@media (max-width:639px){.clients-say-home__heading{font-size:28px;}.clients-say-home__stack{gap:12px;}.clients-say-home__rail{padding:2px 14px;}.clients-say-home__track{gap:12px;}.clients-say-home__track--bottom{padding-left:0;}.clients-say-home__card{width:min(70vw,220px);min-height:150px;padding:14px 15px 13px;border-radius:18px;}.clients-say-home__stars{font-size:14px;}.clients-say-home__text{font-size:15px;line-height:1.3;}.clients-say-home__avatar{width:34px;height:34px;font-size:14px;}.clients-say-home__name{font-size:13px;}.clients-say-home__meta{font-size:11px;}}
