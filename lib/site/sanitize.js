...
.shynli-service-ads-price-old{display:inline-block;opacity:.62;text-decoration:line-through;text-decoration-thickness:.08em;text-decoration-color:rgba(158,67,90,.78);}
...
function buildServiceAdsOfferMarkup(oldPrice, newPrice) {
  return (
    '<span class="shynli-service-ads-hero-offer"><span class="shynli-service-ads-price-line"><span>From <span class="shynli-service-ads-price-old">$' +
    oldPrice +
    '</span></span><span class="shynli-service-ads-price-new">$' +
    newPrice +
...
function customizeRegularCleaningAdsHero(html, routePath) {
  ...
  const output = String(html || "").replace(
    ...
    buildServiceAdsOfferMarkup("200", "135")
  );
...
function customizeDeepCleaningAdsHero(html, routePath) {
  ...
  const output = String(html || "").replace(
    ...
    buildServiceAdsOfferMarkup("300", "195")
  );
