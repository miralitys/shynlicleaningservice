...
.ads2-proof{position:relative;z-index:3;margin:-20px auto 0;padding:16px 18px;border-radius:8px;background:#e8e1d9;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;align-items:center;}
