...
@media (max-width:640px){.shynli-ads-hero-highlight{font-size:21px;line-height:1.08;}.shynli-ads-hero-offer{gap:8px;justify-content:center;font-size:13px;line-height:1.25;}.shynli-ads-countdown{min-width:58px;padding:6px 10px;}.shynli-ads-countdown-button{min-height:30px;padding:0 12px;font-size:11px;}}
</style>`;
...
function customizeAdsHomepageHero(html, routePath) {
  ...
  let output = String(html || "")
    .replace(
      ...
      'Professional Home Cleaning in Chicagoland. <span class="shynli-ads-hero-highlight">From $135 &middot; Same-Day Available &middot; Pay After Done</span>'
    )
    .replace(
