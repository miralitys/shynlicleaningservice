...
.shynli-deep-ads-hero-offer .shynli-ads-countdown-button{margin-top:16px;}
...
#rec1778752073 .t396__carrier{height:910px!important;}
#rec1778752073 .tn-elem[data-elem-id="1768045610727000020"] .tn-atom{font-size:clamp(40px,4vw,52px)!important;line-height:1.05!important;}
#rec1778752073 .tn-elem[data-elem-id="1768045610727000021"]{top:238px!important;left:calc(50% - 600px + 480px)!important;width:700px!important;}
#rec1778752073 .shynli-service-ads-hero-offer{max-width:min(100%,700px);}
#rec1778752073 .shynli-service-ads-price-line{font-size:clamp(26px,3vw,40px);gap:.14em .3em;}
#rec1778752073 .shynli-service-ads-benefits{font-size:clamp(16px,1.8vw,22px);}
#rec1778752073 .shynli-service-ads-timer-line{gap:10px;margin-top:10px;font-size:16px;}
#rec1793182423{margin-top:64px;}
@media screen and (max-width:1199px){
  #rec1778752073 .t396__artboard,
  #rec1778752073 .t396__filter,
  #rec1778752073 .t396__carrier{height:880px!important;}
  #rec1778752073 .tn-elem[data-elem-id="1768045610727000020"] .tn-atom{font-size:43px!important;}
  #rec1778752073 .tn-elem[data-elem-id="1768045610727000021"]{top:238px!important;left:calc(50% - 480px + 352px)!important;width:600px!important;}
...
@media screen and (max-width:959px){
  ...
  #rec1778752073 .tn-elem[data-elem-id="1768045610727000021"]{top:232px!important;left:calc(50% - 320px + 210px)!important;width:430px!important;}
  #rec1778752073 .shynli-service-ads-hero-offer{max-width:min(100%,430px);}
  #rec1778752073 .shynli-service-ads-price-line{font-size:28px;}
  #rec1778752073 .shynli-service-ads-benefits{font-size:16px;}
...
@media screen and (max-width:640px){
  #rec1778752073 .t396__artboard,
  #rec1778752073 .t396__filter,
  #rec1778752073 .t396__carrier{height:800px!important;}
  #rec1778752073 .tn-elem[data-elem-id="1768045610727000020"] .tn-atom{font-size:30px!important;line-height:1.08!important;}
  #rec1778752073 .tn-elem[data-elem-id="1768045610727000021"]{top:198px!important;left:calc(50% - 240px + 16px)!important;width:448px!important;}
...
@media screen and (max-width:479px){
  ...
  #rec1778752073 .tn-elem[data-elem-id="1768045610727000021"]{top:198px!important;left:calc(50% - 160px + 12px)!important;width:296px!important;}
...
function customizeAdsHomepageHero(html, routePath) {
  if (normalizeRoute(routePath) !== "/ads") return html;

  let output = String(html || "")
    .replace(
      /Professional Home Cleaning in Chicagoland\. On Time\. Insured\. No Surprises\./g,
    ...
    .replace(
      /Trusted by 300\+ local families\. Flat pricing\. Safe products\./g,
...
function buildDeepCleaningAdsHeroMarkup() {
  return [
    ...
    '<a class="shynli-ads-countdown-button" href="/quote">GET FREE QUOTE</a>',
    '</span>',
  ].join("");
}
...
function customizeRegularCleaningAdsHero(html, routePath) {
  if (normalizeRoute(routePath) !== "/services/regular-cleaning/ads") return html;

  const output = String(html || "").replace(
    /Keep your home consistently clean, calm, and comfortable with professional service/g,
    buildServiceAdsOfferMarkup("135")
  );

  return injectServiceAdsOfferAssets(output);
}

function customizeDeepCleaningAdsHero(html, routePath) {
  if (normalizeRoute(routePath) !== "/services/deep-cleaning/ads") return html;
