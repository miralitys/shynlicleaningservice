...
@media screen and (max-width:639px){
  ...
  #rec1782880883{display:none!important;}
  .shynli-move-ads-included-accordion{display:block;}
}
@media screen and (max-width:479px){
...
function customizeMoveInMoveOutAdsHero(html, routePath) {
  ...
  output = insertAfterRecord(output, "rec1782880883", buildMoveInMoveOutAdsIncludedAccordion());
