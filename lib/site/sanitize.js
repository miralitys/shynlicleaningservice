...
.shynli-ads-v2-redesign .ads2-service-card img{width:100%;height:156px!important;object-fit:contain;margin:0 auto 12px;}
...
.ads2-review-group{display:flex;gap:16px;padding-right:16px;}
.ads2-review{display:flex;flex-direction:column;justify-content:space-between;width:360px;min-height:292px;padding:22px;border:1px solid rgba(158,67,90,.12);border-radius:8px;background:#fffdfb;}
