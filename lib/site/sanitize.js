...
.ads2-price-item{display:grid;grid-template-columns:minmax(0,.8fr) minmax(120px,.34fr) minmax(0,1fr);gap:18px;align-items:start;padding:17px 0;border-top:1px solid rgba(158,67,90,.14);}
...
.ads2-price-item ul{display:grid;gap:6px;margin:0;padding:0;list-style:none;color:#625d58;font-size:13px;line-height:1.35;}
