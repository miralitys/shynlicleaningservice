...
function customizeAdsHomepageHero(html, routePath) {
  ...
  let output = String(html || "")
    .replace(
      /(?:Professional Home Cleaning in Chicagoland\. On Time\. Insured\. No Surprises\.|House Cleaning Services in Naperville &(?:amp;)? Chicago Suburbs)/g,
    ...
    .replace(
      /(?:Trusted by 300\+ local families\. Flat pricing\. Safe products\.|Reliable regular, deep, and move-out cleaning for busy families in Naperville, Aurora, Sugar Grove, and nearby areas\.)/g,
