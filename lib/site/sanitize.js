...
#rec1778752073 .t396__carrier{height:870px!important;}
#rec1778752073 .tn-elem[data-elem-id="1768045610727000021"]{top:156px!important;}
#rec1778752073 .shynli-service-ads-hero-offer{max-width:min(100%,760px);}
...
@media screen and (max-width:1199px){
  ...
  #rec1778752073 .tn-elem[data-elem-id="1768045610727000021"]{top:150px!important;}
  #rec1793182423{margin-top:48px;}
}
@media screen and (max-width:959px){
  #rec1778752073 .t396__artboard,
  #rec1778752073 .t396__filter,
  #rec1778752073 .t396__carrier{height:760px!important;}
  #rec1778752073 .tn-elem[data-elem-id="1768045610727000021"]{top:142px!important;}
  #rec1778752073 .shynli-service-ads-hero-offer{max-width:min(100%,430px);}
  #rec1778752073 .shynli-service-ads-price-line{font-size:32px;}
  #rec1778752073 .shynli-service-ads-benefits{font-size:18px;}
...
function customizeAdsHomepageHero(html, routePath) {
  ...
  let output = String(html || "")
    .replace(
      ...
      'Professional Home Cleaning in Chicagoland. <span class="shynli-ads-hero-highlight"><span class="shynli-ads-price-pair">From <span class="shynli-ads-price-new">$135</span></span> &middot; Same-Day Available &middot; Pay After Done</span>'
    )
    .replace(
...
function customizeDeepCleaningAdsHero(html, routePath) {
  ...
  const output = String(html || "").replace(
    ...
    buildServiceAdsOfferMarkup("195")
  );

  return injectDeepCleaningAdsLayoutFix(injectServiceAdsOfferAssets(output));
}
