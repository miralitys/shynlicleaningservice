...
.shynli-site-footer{margin:0;padding:34px 0 22px;background:#313131;color:#d8cfc4;font-family:"Montserrat",Arial,sans-serif;}
.shynli-site-footer__shell{width:min(1540px,calc(100% - 96px));margin:0 auto;}
...
body.shynli-ads-v2-page .hero__copy{transform:translateY(28px);}
...
@media (max-width:760px){body.shynli-ads-v2-page .hero__copy{transform:translateY(16px);}}
...
function sanitizeHtml(html, routePath = "/") {
  ...
  if (/<body[\s>]/i.test(cleaned) && !cleaned.includes('id="mobile-sticky-cta"')) {
