...
#blog-topics-hub .shynli-blog-article__hero-visual{padding:0;}
#blog-topics-hub .shynli-blog-article__hero-visual-shell{display:grid;grid-template-columns:minmax(260px,.9fr) minmax(0,1.2fr);gap:18px;padding:28px;border-radius:26px;background:linear-gradient(145deg,#fff8f3 0%,#f1e7dc 100%);border:1px solid rgba(158,68,90,.14);box-shadow:0 22px 44px rgba(49,49,49,.06);}
#blog-topics-hub .shynli-blog-article__hero-visual-copy{display:grid;gap:14px;align-content:start;}
#blog-topics-hub .shynli-blog-article__hero-visual-eyebrow{margin:0;color:#9e445a;font-family:'Montserrat',Arial,sans-serif;font-size:12px;line-height:1.2;font-weight:700;letter-spacing:.18em;text-transform:uppercase;}
#blog-topics-hub .shynli-blog-article__hero-visual-title{margin:0;color:#1f1f1f;font-family:'Playfair Display',serif;font-size:38px;line-height:1.04;font-weight:400;max-width:12ch;}
#blog-topics-hub .shynli-blog-article__hero-visual-text{margin:0;color:#554e49;font-family:'Montserrat',Arial,sans-serif;font-size:15px;line-height:1.76;font-weight:400;max-width:44ch;}
#blog-topics-hub .shynli-blog-article__hero-visual-stats{display:flex;flex-wrap:wrap;gap:10px;}
#blog-topics-hub .shynli-blog-article__hero-visual-stat{display:inline-flex;align-items:center;gap:8px;padding:10px 14px;border-radius:999px;background:rgba(255,255,255,.78);border:1px solid rgba(158,68,90,.12);color:#554e49;font-family:'Montserrat',Arial,sans-serif;font-size:13px;line-height:1.3;font-weight:600;}
#blog-topics-hub .shynli-blog-article__hero-visual-stat strong{color:#9e445a;font-size:16px;font-weight:700;}
#blog-topics-hub .shynli-blog-article__hero-visual-board{display:grid;gap:14px;align-content:start;}
#blog-topics-hub .shynli-blog-article__hero-visual-plan{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;padding:16px;border-radius:24px;background:rgba(255,255,255,.72);border:1px solid rgba(158,68,90,.12);}
#blog-topics-hub .shynli-blog-article__hero-room{display:grid;gap:10px;padding:16px;border-radius:20px;background:#fff;border:1px solid rgba(158,68,90,.1);min-height:138px;box-shadow:0 12px 24px rgba(49,49,49,.04);}
#blog-topics-hub .shynli-blog-article__hero-room.is-wide{grid-column:span 2;}
#blog-topics-hub .shynli-blog-article__hero-room.is-accent{background:linear-gradient(180deg,#fbf1f3 0%,#fff 100%);}
#blog-topics-hub .shynli-blog-article__hero-room-label{margin:0;color:#1f1f1f;font-family:'Playfair Display',serif;font-size:23px;line-height:1.06;font-weight:400;}
#blog-topics-hub .shynli-blog-article__hero-room ul{margin:0;padding:0;list-style:none;display:grid;gap:8px;}
#blog-topics-hub .shynli-blog-article__hero-room li{position:relative;padding-left:22px;color:#5c5550;font-family:'Montserrat',Arial,sans-serif;font-size:13px;line-height:1.55;font-weight:500;}
#blog-topics-hub .shynli-blog-article__hero-room li::before{content:'';position:absolute;left:0;top:.5em;width:9px;height:9px;border-radius:999px;background:#9e445a;box-shadow:0 0 0 4px rgba(158,68,90,.1);}
#blog-topics-hub .shynli-blog-article__hero-visual-note{display:flex;align-items:flex-start;gap:10px;padding:14px 16px;border-radius:18px;background:#313131;color:#faf9f6;font-family:'Montserrat',Arial,sans-serif;font-size:13px;line-height:1.65;font-weight:500;}
#blog-topics-hub .shynli-blog-article__hero-visual-note-dot{width:10px;height:10px;border-radius:999px;background:#d8cfc4;flex:none;box-shadow:0 0 0 6px rgba(216,207,196,.14);margin-top:6px;}
...
.shynli-blog-popup-cta{margin-top:28px;padding-top:24px;border-top:1px solid rgba(49,49,49,.12);}
.shynli-blog-popup-cta .shynli-blog-quote-panel{display:grid;grid-template-columns:1fr;gap:18px;padding:24px;border-radius:24px;background:#efe7de;color:#313131;box-shadow:0 14px 30px rgba(49,49,49,.06);}
.shynli-blog-popup-cta .shynli-blog-quote-panel__eyebrow{margin:0 0 8px;color:#9e445a;font-family:'Montserrat',Arial,sans-serif;font-size:12px;line-height:1.2;font-weight:700;letter-spacing:.16em;text-transform:uppercase;}
.shynli-blog-popup-cta .shynli-blog-quote-panel__title{margin:0;color:#313131;font-family:'Playfair Display',serif;font-size:32px;line-height:1.06;font-weight:400;}
.shynli-blog-popup-cta .shynli-blog-quote-panel__text{margin:12px 0 0;color:#5f5954;font-family:'Montserrat',Arial,sans-serif;font-size:15px;line-height:1.65;font-weight:400;}
.shynli-blog-popup-cta .shynli-blog-quote-form{display:grid;gap:12px;padding:0;background:transparent;}
.shynli-blog-popup-cta .shynli-blog-quote-form>*{min-width:0;}
.shynli-blog-popup-cta .shynli-blog-quote-label{display:block;margin:0 0 6px;color:#313131;font-family:'Montserrat',Arial,sans-serif;font-size:13px;line-height:1.4;font-weight:600;}
.shynli-blog-popup-cta .shynli-blog-quote-input{width:100%;box-sizing:border-box;border:1px solid rgba(49,49,49,.12);border-radius:16px;padding:14px 16px;background:#fff;color:#313131;font-family:'Montserrat',Arial,sans-serif;font-size:16px;line-height:1.4;}
.shynli-blog-popup-cta .shynli-blog-quote-input:focus{outline:none;border-color:#9e445a;box-shadow:0 0 0 3px rgba(158,68,90,.16);}
.shynli-blog-popup-cta .shynli-blog-quote-button{display:flex;align-items:center;justify-content:center;width:100%;min-height:68px;margin:0;padding:18px 24px;border:none;border-radius:999px;background:#9e445a;color:#fff;font-family:'Montserrat',Arial,sans-serif;font-size:15px;line-height:1;font-weight:700;cursor:pointer;box-sizing:border-box;appearance:none;-webkit-appearance:none;text-align:center;}
.shynli-blog-popup-cta .shynli-blog-quote-hint{margin:0;color:#6b645e;font-family:'Montserrat',Arial,sans-serif;font-size:12px;line-height:1.55;font-weight:400;}
.shynli-blog-popup-cta .shynli-blog-quote-hint a{color:inherit;text-decoration:underline;}
...
@media screen and (max-width:959px){
  ...
  #blog-topics-hub .shynli-blog-article__hero-visual-shell{grid-template-columns:1fr;}
  #blog-topics-hub .shynli-blog-article__hero-visual-title{max-width:none;font-size:34px;}
...
@media screen and (max-width:639px){
  ...
  #blog-topics-hub .shynli-blog-article__hero-visual-shell{padding:22px;border-radius:22px;}
  #blog-topics-hub .shynli-blog-article__hero-visual-plan{grid-template-columns:repeat(2,minmax(0,1fr));padding:14px;border-radius:20px;}
  #blog-topics-hub .shynli-blog-article__hero-room.is-wide{grid-column:span 2;}
  ...
  #blog-topics-hub .shynli-blog-article__hero-visual-title{font-size:30px;}
  #blog-topics-hub .shynli-blog-article__hero-room-label{font-size:20px;}
  ...
  #blog-topics-hub .shynli-blog-quote-panel__title,
  .shynli-blog-popup-cta .shynli-blog-quote-panel__title{font-size:28px;}
  #blog-topics-hub .shynli-blog-quote-form,
  .shynli-blog-popup-cta .shynli-blog-quote-form{padding:0;}
}
@media screen and (max-width:479px){
  #blog-topics-hub .shynli-blog-article__hero-visual-plan{grid-template-columns:1fr;}
  #blog-topics-hub .shynli-blog-article__hero-room,
  #blog-topics-hub .shynli-blog-article__hero-room.is-wide{grid-column:auto;min-height:auto;}
  #blog-topics-hub .shynli-blog-article__hero-visual-title{font-size:26px;}
  #blog-topics-hub .shynli-blog-article__hero-visual-stats{gap:8px;}
  #blog-topics-hub .shynli-blog-article__hero-visual-stat{width:100%;justify-content:space-between;}
}
</style>`;
}
...
(function(){
  ...
  var CURRENT_CATEGORY = ${JSON.stringify(currentCategory)};
  ...
  function bindArticleTocLinks(root){
    Array.prototype.slice.call((root || document).querySelectorAll('.shynli-blog-article__toc-link')).forEach(function(link){
  ...
  function scrollToHashIfNeeded(){
    var targetId = String(window.location.hash || '').replace(/^#/, '');
    if(!targetId) return;
    var target = document.getElementById(targetId);
    if(!target) return;
    setTimeout(function(){
  ...
  function buildPopupCtaMarkup(){
    return [
      '<section class="shynli-blog-popup-cta">',
      '<div class="shynli-blog-quote-panel">',
      '<div class="shynli-blog-quote-panel__copy">',
      '<p class="shynli-blog-quote-panel__eyebrow">Need help instead?</p>',
      '<h3 class="shynli-blog-quote-panel__title">Get a cleaning quote while this guide is fresh.</h3>',
      '<p class="shynli-blog-quote-panel__text">Leave your name and phone, and continue to the quote flow in one step with your details prefilled.</p>',
      '</div>',
      '<form class="shynli-blog-quote-form" data-blog-quote-form>',
      '<div><label class="shynli-blog-quote-label">Your name<input class="shynli-blog-quote-input" type="text" name="name" autocomplete="name" placeholder="Enter your name" required></label></div>',
      '<div><label class="shynli-blog-quote-label">Phone number<input class="shynli-blog-quote-input" type="tel" name="phone" autocomplete="tel" placeholder="(000) 000-0000" inputmode="tel" maxlength="14" required></label></div>',
      '<button class="shynli-blog-quote-button" type="submit">Continue to quote</button>',
      '<p class="shynli-blog-quote-hint">By submitting, you agree to our <a href="/terms-of-service">Terms of Service</a>.</p>',
      '</form>',
      '</div>',
      '</section>'
    ].join('');
  ...
  function injectPopupCtas(root){
    Array.prototype.slice.call((root || document).querySelectorAll('.t-popup')).forEach(function(popup){
      var hasFeedContent = popup.querySelector('.t-feed__post-popup, .t-feed__post-popup__textwrapper, .t-feed__post-popup__content, [class*="t-feed__post-popup"]');
      if(!hasFeedContent) return;
      var target = popup.querySelector('.t-feed__post-popup__content, .t-feed__post-popup__textwrapper, .t-feed__post-popup__all-text-wrapper, .t-feed__post-popup__descr, .t-feed__post-popup') || popup.querySelector('.t-popup__container');
      if(!target || target.querySelector('.shynli-blog-popup-cta')) return;
      target.insertAdjacentHTML('beforeend', buildPopupCtaMarkup());
      initQuoteForms(target);
    });
  }
  ...
  function activateFeedFilter(attempt){
    if(!CURRENT_CATEGORY) return;
    var buttons = Array.prototype.slice.call(document.querySelectorAll('.t-feed__parts-switch-btn'));
    if(!buttons.length){
      if((attempt || 0) < 10) setTimeout(function(){ activateFeedFilter((attempt || 0) + 1); }, 300);
      return;
    }

    var aliases = (CURRENT_CATEGORY.aliases || [CURRENT_CATEGORY.label]).map(normalizeText).filter(Boolean);
    var activated = false;
    buttons.forEach(function(button){
      var text = normalizeText(button.textContent || '');
      if(!text) return;
      var matches = aliases.some(function(alias){
        return text === alias || text.indexOf(alias) !== -1 || alias.indexOf(text) !== -1;
      });
      if(!matches) return;
      var target = button.querySelector('button, a') || button;
      if(button.classList.contains('t-active')){
        activated = true;
        return;
      }
    ...
    if(!activated && (attempt || 0) < 10){
      setTimeout(function(){ activateFeedFilter((attempt || 0) + 1); }, 300);
    }
  }
  ...
  function boot(){
    ...
    bindArticleTocLinks(document);
    injectPopupCtas(document);
    activateFeedFilter(0);
  ...
  if(window.MutationObserver && document.body){
    var observer = new MutationObserver(function(){
      ...
      bindPrintButtons(document);
      bindArticleTocLinks(document);
      if(CURRENT_CATEGORY) activateFeedFilter(0);
    });
...
function removeBlogEmptyFeedSections(html, routePath) {
  if (!isManagedBlogRoute(routePath)) return html;
  if (!BLOG_EMPTY_FEEDS_PATTERN.test(html)) return html;
  return html.replace(BLOG_EMPTY_FEEDS_PATTERN, "");
}
...
function sanitizeHtml(html, routePath = "/") {
  ...
  cleaned = removeBlogEmptyFeedSections(cleaned, routePath);
