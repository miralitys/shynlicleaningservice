...
function sanitizeHtml(html, routePath = "/") {
  ...
  if (normalizedRoute === "/" || normalizedRoute === "/romeoville") {
    cleaned = cleaned
      .replace(/<script[^>]+src="js\/tilda-scripts-3\.0\.min\.js"[^>]*><\/script>\s*/g, "")
      .replace(/<script[^>]+src="js\/tilda-blocks-page108488156\.min\.js(?:\?t=\d+)?"[^>]*><\/script>\s*/g, "")
      .replace(/<script[^>]+src="js\/tilda-blocks-page111640886\.min\.js(?:\?t=\d+)?"[^>]*><\/script>\s*/g, "")
