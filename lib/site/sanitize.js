...
body.shynli-deep-cleaning-ads-page .dc-areas{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;width:100%!important;margin:30px 0 0!important;}
...
body.shynli-deep-cleaning-ads-page .dc-area__content{display:grid;grid-template-rows:1fr!important;}
body.shynli-deep-cleaning-ads-page .dc-area__inner{overflow:hidden;padding:0 22px 22px!important;}
...
@media screen and (max-width:959px){
  ...
  body.shynli-deep-cleaning-ads-page .dc-area__content{grid-template-rows:0fr!important;}
  ...
  body.shynli-deep-cleaning-ads-page .dc-area__inner{padding:0 16px 18px!important;}
