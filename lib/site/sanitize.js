...
@media (min-width:961px){
  .shynli-blog-shell__details[open]::after{
    content:"";
    position:absolute;
    top:100%;
    left:-16px;
...
function buildBlogShellCityMenuDesktop() {
  return `<details class="shynli-blog-shell__details shynli-blog-shell__details--align-right"><summary class="shynli-blog-shell__button shynli-blog-shell__button-summary is-secondary">City ▾</summary><div class="shynli-blog-shell__submenu shynli-blog-shell__submenu--city"><p class="shynli-blog-shell__submenu-title">Popular Cities</p><div class="shynli-blog-shell__city-grid">${BLOG_SHELL_CITY_LINKS.map(
