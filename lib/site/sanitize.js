...
.shynli-ads-price-old{display:inline-block;opacity:.62;text-decoration:line-through;text-decoration-thickness:.08em;text-decoration-color:rgba(158,67,90,.78);}
...
(() => {
  ...
  function showPopup() {
    ...
    popup.innerHTML = '<div class="shynli-ads-lead-dialog"><button class="shynli-ads-lead-close" type="button" aria-label="Close">&times;</button><p class="shynli-ads-lead-brand">Shynli Cleaning Service</p><h2 class="shynli-ads-lead-title" id="shynli-ads-lead-title">What service do you need?</h2><div class="shynli-ads-lead-step" data-step="service"><div class="shynli-ads-lead-service-grid"><button class="shynli-ads-lead-service" type="button" data-service="regular" aria-pressed="false">Regular Cleaning</button><button class="shynli-ads-lead-service" type="button" data-service="deep" aria-pressed="false">Deep Cleaning</button></div></div><form class="shynli-ads-lead-contact" data-shynli-ads-lead-form><p class="shynli-ads-lead-prompt">Leave your phone number and full name.</p><div class="shynli-ads-lead-fields"><input class="shynli-ads-lead-field" name="fullName" type="text" autocomplete="name" placeholder="Full name" required><input class="shynli-ads-lead-field" name="phone" type="text" inputmode="tel" autocomplete="tel" placeholder="+1 (000) 000-0000" required></div><button class="shynli-ads-lead-submit" type="submit">Send request</button><p class="shynli-ads-lead-status" data-shynli-ads-lead-status aria-live="polite"></p></form><div class="shynli-ads-lead-thanks" data-shynli-ads-lead-thanks><p class="shynli-ads-lead-thanks-title">Thank you</p><p class="shynli-ads-lead-thanks-text">Thank you, we will contact you shortly.</p></div></div>';
...
function customizeAdsHomepageHero(html, routePath) {
  ...
  let output = String(html || "")
    .replace(
      ...
      'Professional Home Cleaning in Chicagoland. <span class="shynli-ads-hero-highlight"><span class="shynli-ads-price-pair"><span class="shynli-ads-price-old">From $200</span> <span class="shynli-ads-price-new">$135</span></span> &middot; Same-Day Available &middot; Pay After Done</span>'
    )
    .replace(
      /Trusted by 300\+ local families\. Flat pricing\. Safe products\./g,
      '<span class="shynli-ads-hero-offer"><span class="shynli-ads-countdown-label">Offer ends in</span><span class="shynli-ads-countdown" data-shynli-ads-countdown>05:00</span><a class="shynli-ads-countdown-button" href="/quote">GET FREE QUOTE</a></span>'
    );
