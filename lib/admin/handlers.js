      ...
      try {
        ...
        if (transitionedToScheduled) {
          ...
          const enteredScheduledStage =
            ...
            previousOrderStatus !== "scheduled" &&
            nextOrderStatus === "scheduled" &&
          ...
          if (
            ...
            try {
              const pendingAcceptance = await orderPolicyAcceptance.buildPendingAcceptance(updatedEntry);
              ...
              if (!customerEmail) {
                const failedRecord = orderPolicyAcceptance.buildFailedSendRecord(
                  ...
                  new Error("Recipient email is missing.")
                );
                updatedEntry = await quoteOpsLedger.updateOrderEntry(entryId, {
                  policyAcceptance: failedRecord,
                });
                policyEmailState = "missing-recipient";
