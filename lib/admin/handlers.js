    ...
    if (requestContext.route === ADMIN_ORDERS_PATH && req.method === "POST") {
      ...
      try {
        ...
        if (action === "delete-order") {
          ...
          if (deleted && orderMediaStorage && existingEntry) {
        ...
        const updatedEntry = await quoteOpsLedger.updateOrderEntry(entryId, {
          ...
          assignedStaff: getFormValues(formBody, "assignedStaff", 8, 120).join(", "),
          paymentStatus: getFormValue(formBody, "paymentStatus", 40),
          paymentMethod: getFormValue(formBody, "paymentMethod", 40),
          totalPrice: getFormValue(formBody, "totalPrice", 64),
