...
function createAdminPageRenderers(deps = {}) {
  ...
  async function renderQuoteOpsPage(req, config, quoteOpsLedger) {
    ...
    const filtersSummary = hasActiveFilters
      ? "Активные фильтры сузили ленту до нужных заявок."
      : "Сейчас показан весь поток входящих заявок без ограничений.";
        ...
        <section class="admin-orders-filters-panel admin-quote-ops-filter-shell">
          <div class="admin-orders-panel-head">
            <div>
              ...
              <p class="admin-orders-panel-copy">Поиск по имени, телефону, email, request ID и адресу. Фильтры открываются по кнопке, чтобы рабочая лента оставалась короткой и чистой.</p>
            </div>
          ...
          <div class="admin-quote-ops-filter-meta">
            ...
            <div class="admin-quote-ops-filter-meta-row">
              ...
              <span class="admin-action-hint">Нажмите на имя клиента, чтобы открыть полную заявку.</span>
            </div>
          </div>
        </section>
