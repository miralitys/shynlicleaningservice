      ...
      `<div class="admin-quote-ops-page">
        ...
        <section class="admin-orders-filters-panel admin-quote-ops-filter-shell">
          ...
          <form class="admin-quote-ops-filter-form" method="get" action="${ADMIN_QUOTE_OPS_PATH}">
            <div class="admin-quote-ops-filter-top-row">
            ...
            <div class="admin-quote-ops-filter-bottom-row">
              <label class="admin-label">
                Статус
                <select class="admin-input" name="status">
                  <option value="all"${filters.status === "all" ? " selected" : ""}>Все</option>
              ...
              <span class="admin-action-hint admin-quote-ops-filter-hint">${escapeHtml(filtersSummary)}</span>
            </div>
          </form>
        </section>
