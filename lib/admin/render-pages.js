    ...
    >
      ...
      <div class="admin-quote-funnel-card-details">
        <div class="admin-quote-funnel-card-detail">
          ...
          <p class="admin-quote-funnel-card-detail-value admin-quote-funnel-card-detail-value-multiline">${escapeHtml(taskLabel)}</p>
        </div>
        <div class="admin-quote-funnel-card-detail">
          <p class="admin-quote-funnel-card-detail-label${isOverdue ? " admin-quote-funnel-card-detail-label-danger" : ""}">Дедлайн</p>
