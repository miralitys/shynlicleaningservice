  ...
  function renderQuoteOpsFunnelCard(entry, returnTo) {
    ...
    >
      ...
      <div class="admin-quote-funnel-card-manager">
        ...
        <p class="admin-quote-funnel-card-manager-name" data-quote-card-manager-name="true">${escapeHtml(managerLabel)}</p>
      </div>
  ...
  function renderQuoteOpsFunnelScript(activeSection) {
    return `<script>
      (() => {
        ...
        function buildAjaxErrorMessage(payload) {
          ...
          return "Не удалось сохранить новый этап заявки.";
        }
