  ...
  function renderOrderManagementDialog(order, returnTo, options = {}) {
    ...
    const amountHighlightCardMarkup = `<article class="admin-order-highlight-card">
      <div class="admin-order-highlight-head">
        ...
        ${renderAdminToggleIconButton("Изменить сумму", amountEditPanelId, {
          openLabel: "Скрыть редактирование суммы",
          closedLabel: "Изменить сумму",
        })}
      </div>
      ...
      <div class="admin-order-highlight-editor" id="${escapeHtmlAttribute(amountEditPanelId)}" data-admin-toggle-panel hidden>
