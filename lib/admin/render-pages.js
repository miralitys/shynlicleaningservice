        ...
        calendarWraps.forEach((wrap) => {
          ...
          const centerAnchorCell = () => {
            ...
            const targetScrollLeft = Math.max(
              0,
              anchor.offsetLeft - (wrap.clientWidth / 2) + (anchor.clientWidth / 2)
            );
        ...
        <table class="admin-table admin-team-calendar-table" data-admin-team-calendar="true" style="--admin-team-calendar-days:${escapeHtmlAttribute(String(days.length))};">
          <thead>
            <tr>
              ...
              ${days
                .map(
                  (day) => `<th${day.dateValue === normalizedStartDate ? ' data-admin-team-calendar-anchor="true"' : ""}>
            ...
            ${staffSummaries
              .map(
                (staffSummary) => `<tr>
                  ...
                  ${days.map((day) => `<td class="admin-team-calendar-day-cell"${day.dateValue === normalizedStartDate ? ' data-admin-team-calendar-anchor="true"' : ""}>${renderStaffTeamCalendarCell(staffSummary, day)}</td>`).join("")}
                </tr>`
              )
              .join("")}
          </tbody>
