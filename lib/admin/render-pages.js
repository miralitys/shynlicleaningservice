    ...
    const quoteCards = [
      `<article class="admin-order-quote-card admin-order-quote-card-wide">
        ...
        <div class="admin-order-quote-fields admin-order-quote-fields-primary">
          ...
          ${renderOrderQuoteField("Запрошенный слот", formatOrderQuoteRequestedSlot(quoteData.formattedDateTime, quoteData.selectedDate || entry.selectedDate, quoteData.selectedTime || entry.selectedTime))}
