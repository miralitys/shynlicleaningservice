...
function createAdminPageRenderers(deps = {}) {
  ...
  function renderAdminClientAddressProfileSection(addressRecord) {
    ...
    return `<section class="admin-client-section">
      ...
      ${renderAdminClientInfoGrid([
        {
          label: "Тип объекта",
          value: formatAdminClientAddressPropertyTypeLabel(addressRecord.propertyType),
        },
        {
          label: "Метраж / комнаты",
          value: normalizeString(addressRecord.sizeDetails, 250) || "Не указано",
        },
        {
          label: "Домашние животные",
          value: formatAdminClientAddressPetsLabel(addressRecord.pets),
        },
        {
          label: "Особые инструкции",
          value: normalizeString(addressRecord.notes, 800) || "Пока без заметок",
          wide: true,
        },
      ], {
        compact: true,
        ...
        <div class="admin-form-grid admin-form-grid-three admin-client-address-detail-grid">
          ...
          <label class="admin-label">
            ...
            <input
              class="admin-input"
              type="text"
              name="addressHomeProfiles"
              value="${escapeHtmlAttribute(normalizeString(addressRecord.sizeDetails, 250))}"
              placeholder="1600 sq ft / 3 комнаты"
            >
          </label>
          <label class="admin-label">
            Домашние животные
  ...
  function renderAdminClientEditPanel(client, returnTo = ADMIN_CLIENTS_PATH, panelId = "") {
    ...
    const initialAddresses = addressValues.length > 0
      ? addressValues
      : [{ address: "", propertyType: "", sizeDetails: "", pets: "", notes: "" }];
