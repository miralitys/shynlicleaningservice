...
.admin-clients-segment-group .admin-action-hint {
  margin-right: 2px;
}
.admin-clients-segment-strip .admin-button,
.admin-clients-segment-strip .admin-link-button {
  min-height: 36px;
  padding: 0 12px;
  box-shadow: none;
}
