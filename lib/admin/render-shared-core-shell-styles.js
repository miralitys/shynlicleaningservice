...
const ADMIN_SHARED_CORE_SHELL_STYLES = `
      ...
      * { box-sizing: border-box; }
      ...
      .admin-nav-sublink-danger {
        border-color: rgba(158, 67, 90, 0.30);
        background: linear-gradient(135deg, #9e435a, #b2526d);
        color: #fff;
        box-shadow: 0 14px 34px rgba(158, 67, 90, 0.18);
      }
      .admin-nav-sublink-danger:hover {
        border-color: rgba(158, 67, 90, 0.44);
        background: linear-gradient(135deg, #8f394f, #b2526d);
        color: #fff;
      }
      .admin-nav-sublink-danger::before {
