...
${ADMIN_SHARED_RESPONSIVE_STYLES}
  ...
  <body>
    ...
    <dialog class="admin-dialog admin-confirm-dialog" id="admin-save-confirm-dialog" aria-labelledby="admin-save-confirm-title" aria-describedby="admin-save-confirm-copy">
      <div class="admin-dialog-panel">
        <div class="admin-dialog-copy-block">
          <p class="admin-card-eyebrow">Подтверждение</p>
          <h2 class="admin-dialog-title" id="admin-save-confirm-title">Сохранить?</h2>
          <p class="admin-dialog-copy" id="admin-save-confirm-copy">Изменения сохранятся только после подтверждения.</p>
        </div>
        <div class="admin-inline-actions admin-confirm-dialog-actions">
          <button class="admin-button admin-button-secondary" type="button" data-admin-dialog-close="admin-save-confirm-dialog" data-admin-save-confirm-cancel>Нет</button>
          <button class="admin-button admin-button-secondary" type="button" data-admin-reminder-confirm-skip hidden>Don’t send</button>
          <button class="admin-button" type="button" data-admin-save-confirm-accept="true">Сохранить</button>
        </div>
      </div>
    </dialog>
    <script>
