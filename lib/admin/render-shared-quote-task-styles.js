...
.admin-dashboard-task-table th,
.admin-dashboard-task-table td {
  white-space: normal !important;
}
.admin-dashboard-task-table th:nth-child(1),
.admin-dashboard-task-table td:nth-child(1) {
  width: 30%;
}
.admin-dashboard-task-table th:nth-child(2),
.admin-dashboard-task-table td:nth-child(2) {
  width: 16%;
}
.admin-dashboard-task-table th:nth-child(3),
.admin-dashboard-task-table td:nth-child(3) {
  width: 18%;
}
.admin-dashboard-task-table th:nth-child(4),
.admin-dashboard-task-table td:nth-child(4) {
  width: 20%;
}
.admin-dashboard-task-table th:nth-child(5),
.admin-dashboard-task-table td:nth-child(5) {
  width: 16%;
}
.admin-dashboard-task-table .admin-table-cell-stack,
.admin-dashboard-task-table .admin-quote-task-pill-row {
  max-width: 100%;
  overflow: hidden;
}
.admin-dashboard-task-table .admin-table-strong,
.admin-dashboard-task-table .admin-table-muted {
  display: block;
  max-width: 100%;
  overflow: hidden;
  text-overflow: ellipsis;
}
.admin-dashboard-task-table td:nth-child(2) .admin-table-strong {
  white-space: nowrap;
}
.admin-dashboard-task-deadline-stack {
  align-items: start;
  gap: 6px;
}
.admin-dashboard-task-overdue-badge {
  display: inline-flex;
  max-width: 100%;
}
.admin-dashboard-task-table .admin-badge {
  max-width: 100%;
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
