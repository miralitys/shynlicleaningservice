...
function renderQuoteOpsWorkspaceStyle() {
  return `<style>
    ...
    .admin-dialog.admin-quote-manual-task-dialog {
    ...
    .admin-quote-manual-task-dialog .admin-dialog-head {
      display: block;
      padding-right: 88px;
    }
    .admin-quote-manual-task-dialog .admin-dialog-copy {
      max-width: 440px;
    }
    .admin-quote-manual-task-dialog .admin-dialog-head-actions {
      position: absolute;
      top: 24px;
      right: 24px;
      width: auto;
    ...
    .admin-quote-task-client-picker {
      position: relative;
      z-index: 4;
    }
    .admin-quote-task-client-search-shell {
      position: relative;
    }
    .admin-quote-task-client-search-icon {
      position: absolute;
      left: 16px;
      top: 50%;
    ...
    .admin-quote-task-client-search {
      padding-left: 46px;
      padding-right: 16px;
    }
    .admin-quote-task-client-results {
      position: absolute;
      z-index: 20;
      left: 0;
      right: 0;
      ...
      overflow-y: auto;
      border: 1px solid rgba(158, 67, 90, 0.24);
      border-radius: 8px;
      background: #fff;
      box-shadow: 0 22px 54px rgba(15, 23, 42, 0.18);
    }
    .admin-quote-task-client-results[hidden] {
      display: none;
    }
    .admin-quote-task-client-result {
      width: 100%;
      display: grid;
      gap: 5px;
      padding: 12px 14px;
    ...
    .admin-quote-task-client-result[hidden] {
      display: none !important;
    }
    .admin-quote-task-client-result:last-of-type {
      border-bottom: 0;
    }
    .admin-quote-task-client-result:hover,
    .admin-quote-task-client-result:focus-visible {
      outline: none;
      background: rgba(158, 67, 90, 0.07);
    }
    .admin-quote-task-client-result-head,
    .admin-quote-task-client-result-foot,
    .admin-quote-task-client-selection-main,
    .admin-quote-task-client-selection-foot {
      display: flex;
      align-items: center;
      justify-content: space-between;
      gap: 12px;
    }
    .admin-quote-task-client-result-head strong {
      min-width: 0;
      overflow-wrap: anywhere;
      font-size: 15px;
    }
    .admin-quote-task-client-result-meta,
    .admin-quote-task-client-result-foot,
    .admin-quote-task-client-selection p,
    .admin-quote-task-client-selection-foot,
    .admin-field-help {
      color: var(--muted);
      font-size: 12px;
    ...
    .admin-quote-task-client-result-foot span:last-child {
      text-align: right;
    }
    .admin-quote-task-client-empty {
      margin: 0;
      padding: 18px;
      color: var(--muted);
      text-align: center;
    }
    .admin-quote-task-client-selection {
      display: grid;
      gap: 8px;
      padding: 13px 14px;
    ...
    .admin-quote-task-client-selection[hidden] {
      display: none;
    }
    .admin-quote-task-client-selection strong {
      display: block;
      font-size: 16px;
      line-height: 1.3;
    }
    ...
    .admin-quote-task-client-selection-foot {
      ...
      flex-wrap: wrap;
      padding-top: 7px;
      border-top: 1px solid rgba(21, 128, 110, 0.15);
      font-weight: 600;
    }
    .admin-quote-task-client-change {
      min-height: 34px;
      padding: 0 12px;
      flex: 0 0 auto;
    }
    .admin-quote-task-field-error {
      margin: 0;
      color: #b42318;
      font-size: 12px;
      font-weight: 600;
    }
    .admin-quote-task-preset-row {
      display: flex;
      flex-wrap: wrap;
      gap: 7px;
      margin-bottom: 2px;
    }
    .admin-quote-task-preset {
      min-height: 34px;
      padding: 6px 11px;
      border: 1px solid rgba(158, 67, 90, 0.20);
      border-radius: 8px;
    ...
    .admin-quote-task-preset:hover,
    .admin-quote-task-preset:focus-visible,
    .admin-quote-task-preset[data-active="true"] {
      outline: none;
      border-color: rgba(158, 67, 90, 0.48);
      background: rgba(158, 67, 90, 0.10);
      color: var(--accent);
    }
    .admin-quote-manual-task-form .admin-field-help {
      display: block;
      margin-top: -2px;
      font-weight: 500;
    }
    ...
    .admin-table.admin-quote-task-table th,
    .admin-table.admin-quote-task-table td {
      min-width: 0;
      padding: 10px 12px;
      vertical-align: top;
      white-space: normal;
    ...
    .admin-quote-task-table td:nth-child(2) .admin-table-strong,
    .admin-quote-task-table td:nth-child(5) .admin-table-strong {
      overflow: hidden;
      text-overflow: ellipsis;
      white-space: nowrap;
    }
    ...
    .admin-quote-entry-summary-stack {
      width: 100%;
      flex: 1 1 100%;
    }
    .admin-quote-entry-stage-focus {
      display: grid;
      gap: 10px;
      width: 100%;
    }
    .admin-quote-entry-stage-focus .admin-subsection-head {
      margin: 0;
    }
    .admin-quote-entry-stage-card {
      border-color: rgba(158, 67, 90, 0.22);
      background:
        radial-gradient(circle at top left, rgba(158, 67, 90, 0.08), transparent 36%),
        linear-gradient(180deg, rgba(255,255,255,0.98), rgba(255,250,251,0.98));
      box-shadow: 0 14px 34px rgba(158, 67, 90, 0.10);
    }
    ...
    .admin-quote-entry-detail-grid-single {
      grid-template-columns: minmax(0, 1fr);
    }
    ...
    .admin-quote-entry-stage-form {
      grid-template-columns: minmax(180px, 0.85fr) minmax(220px, 1fr) minmax(280px, 1.65fr);
      align-items: end;
      max-width: none;
    }
    ...
    .admin-quote-entry-task-summary th:nth-child(1),
    .admin-quote-entry-task-summary td:nth-child(1) {
      width: 55%;
    }
    .admin-quote-entry-task-summary th:nth-child(2),
    .admin-quote-entry-task-summary td:nth-child(2) {
      width: 27%;
    }
    .admin-quote-entry-task-summary th:nth-child(3),
    .admin-quote-entry-task-summary td:nth-child(3) {
      width: 18%;
    }
