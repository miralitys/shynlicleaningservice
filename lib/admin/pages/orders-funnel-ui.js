...
function createOrdersFunnelUi(deps = {}) {
  ...
  function renderOrdersFunnelStyle() {
    return `<style>
      ...
      .admin-order-funnel-card-detail { display: grid; grid-template-columns: minmax(0, 58px) minmax(0, 1fr); align-items: start; gap: 8px; }
      ...
      .admin-order-funnel-card-stage { display: grid; gap: 6px; }
      .admin-order-funnel-card-stage .admin-badge { display: flex; width: 100%; justify-content: center; text-align: center; }
