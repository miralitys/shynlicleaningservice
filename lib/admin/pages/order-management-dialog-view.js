  ...
  function renderOrderManagementDialog(order, returnTo, options = {}) {
    ...
    >
      ...
      >
        ...
        ${(order.frequency || order.recurringNextEntryId)
          ...
          <article class="admin-order-quote-card admin-order-quote-card-wide">
            ...
            ${(order.frequency || order.recurringNextEntryId)
              ? `<label class="admin-label admin-order-quote-edit-wide">
                  ...
                  <select class="admin-input" name="commentEditScope">
                    <option value="current">Только для этой уборки</option>
                    <option value="future">Для этой и всех следующих уборок</option>
                  </select>
                </label>`
              : ""}
          </article>
