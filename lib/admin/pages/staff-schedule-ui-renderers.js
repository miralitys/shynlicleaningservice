...
function getStaffTeamCalendarViewDayCount(view) {
  ...
  if (normalizedView === "month") return 63;
  return 14;
}
...
function buildStaffTeamCalendarWindow(anchorDateValue, view = "week") {
  ...
  const firstDate = normalizedView === "month"
    ? addMonthsToStaffCalendarDate(anchorDate, -1)
    : anchorDate;
  const lastDate = normalizedView === "month" ? addMonthsToStaffCalendarDate(anchorDate, 1) : "";
