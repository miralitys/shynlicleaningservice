...
function createPayrollPageRenderer(deps = {}) {
  ...
  function renderPayrollCleanerActivityControls(reqUrl, cleanerDirectory = [], activityFilters = {}) {
    ...
    return `<div class="admin-payroll-cleaner-controls">
      <form class="admin-orders-filter-bar admin-payroll-cleaner-filter" method="get" action="${ADMIN_PAYROLL_PATH}">
      ...
      <div class="admin-inline-badge-row admin-payroll-cleaner-directory">
