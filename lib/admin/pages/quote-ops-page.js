      ...
      <div class="admin-dialog-panel">
        <div class="admin-dialog-head">
          <div class="admin-dialog-copy-block">
            ...
            <p class="admin-dialog-copy">Добавьте задачу к заявке и назначьте исполнителя: менеджера или админа.</p>
          </div>
        ...
        <label class="admin-label">
          ...
          <select class="admin-input" name="assigneeId" required>
            ...
            ${taskAssigneeOptions.map((assignee) => `
              <option value="${escapeHtmlAttribute(assignee.id)}">${escapeHtml(assignee.label || assignee.name)}</option>
            `).join("")}
          </select>
        </label>
