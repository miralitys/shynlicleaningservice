...
.admin-order-quote-section-head {
  align-items: center;
}
.admin-order-quote-edit-panel {
  display: grid;
  gap: 12px;
  padding: 14px;
...
.admin-order-quote-edit-panel[hidden] {
  display: none !important;
}
.admin-order-quote-edit-form,
.admin-order-quote-edit-fields {
  gap: 12px;
}
.admin-order-quote-edit-wide,
.admin-order-quote-service-checkboxes {
  grid-column: 1 / -1;
}
.admin-order-quote-edit-actions {
  grid-column: 1 / -1;
