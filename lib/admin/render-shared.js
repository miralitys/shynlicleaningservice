    ...
    <script>
      (() => {
        ...
        function renderAdminSmsHistoryListHtml(items) {
          ...
          return '<div class="admin-history-list admin-ghl-sms-history-list">' + items.map((item) => {
            ...
            return '<article class="admin-history-item admin-client-history-item admin-ghl-sms-history-item">' +
              '<div class="admin-client-history-header">' +
                ...
                "</div>" +
                '<div class="admin-client-history-side admin-ghl-sms-history-badges">' + badges + "</div>" +
              "</div>" +
