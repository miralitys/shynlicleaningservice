  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .admin-order-brief-visit {
        display: grid;
        gap: 12px;
        grid-template-columns: minmax(0, 1.35fr) minmax(240px, 0.65fr);
        align-items: start;
      }
      .admin-order-brief-slot,
      .admin-order-brief-total {
        display: grid;
        gap: 8px;
        min-width: 0;
        padding: 16px;
      ...
      .admin-order-brief-slot-value,
      .admin-order-brief-total-value {
        margin: 0;
        color: var(--foreground);
        font-weight: 700;
        letter-spacing: -0.03em;
