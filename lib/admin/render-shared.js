    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .admin-nav-group {
        ...
        border: 1px solid rgba(24, 24, 27, 0.05);
        border-radius: 20px;
        background: linear-gradient(180deg, rgba(250,250,251,0.92), rgba(255,255,255,0.78));
        box-shadow: inset 0 1px 0 rgba(255,255,255,0.72);
      }
      .admin-nav-group-active {
        border-color: rgba(158, 67, 90, 0.12);
        background: linear-gradient(180deg, rgba(158, 67, 90, 0.06), rgba(255,255,255,0.88));
      }
      ...
      .admin-nav-link-active {
        border-color: rgba(158, 67, 90, 0.24);
        background: linear-gradient(180deg, rgba(158, 67, 90, 0.14), rgba(255,255,255,0.96));
        color: var(--accent);
        font-weight: 700;
        box-shadow: 0 10px 18px rgba(158, 67, 90, 0.10), inset 0 1px 0 rgba(255,255,255,0.7);
      }
      ...
      @media (max-width: 720px) {
        ...
        .admin-client-action-row > .admin-client-delete-form {
          width: auto;
          margin-left: auto;
        }
        .admin-input-code {
