    ...
    return entries
      ...
      .map((entry) => {
        ...
        return {
          ...
          assignedStaff,
          recurringNextEntryId: normalizeString((getEntryAdminOrderData(entry) || {}).recurringNextEntryId, 120),
          recurringGeneratedAt: normalizeString((getEntryAdminOrderData(entry) || {}).recurringGeneratedAt, 80),
          selectedDate,
          selectedTime,
