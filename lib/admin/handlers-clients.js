  ...
  async function handleAdminClientsPostRoute(context = {}) {
    ...
    try {
      ...
      if (action === "update-client") {
        ...
        const hasSecondaryPhoneField =
          (typeof formBody.has === "function" && formBody.has("secondaryPhone")) ||
          Object.prototype.hasOwnProperty.call(formBody || {}, "secondaryPhone");
        if (hasSecondaryPhoneField) {
          updates.secondaryPhone = getFormValue(formBody, "secondaryPhone", 80);
        }
        if (!updates.name) {
          if (ajaxRequest) {
