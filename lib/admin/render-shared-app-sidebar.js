...
function renderAdminAppSidebarItem({
  ...
  const quoteOpsSubnav = isQuoteOpsItem
    ? `<div class="admin-nav-sublinks">
                    ...
                    ${activeQuoteOpsSection === "tasks"
                      ? `<button class="admin-nav-sublink admin-nav-sublink-button admin-nav-sublink-danger" type="button" data-admin-dialog-open="admin-quote-create-task-dialog">Создать таск</button>`
                      : ""}
                  </div>`
    : "";
