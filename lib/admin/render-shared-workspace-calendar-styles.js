...
.admin-team-calendar-day-cell[data-admin-team-calendar-empty="true"] {
  cursor: copy;
}
.admin-team-calendar-day-cell[data-admin-team-calendar-empty="true"]:hover,
.admin-team-calendar-day-cell[data-admin-team-calendar-empty="true"]:focus-visible {
  background:
    linear-gradient(180deg, rgba(255, 255, 255, 0.76), var(--admin-staff-color-soft, #eff6ff));
  box-shadow: inset 0 0 0 2px var(--admin-staff-color-border, rgba(37, 99, 235, 0.24));
}
.admin-team-calendar-day-cell[data-admin-team-calendar-empty="true"]:focus-visible {
  outline: 2px solid var(--admin-staff-color, #2563eb);
  outline-offset: -2px;
}
...
.admin-team-calendar-unavailable-clear-form {
  display: flex;
  justify-content: flex-start;
  margin: 2px 0 0;
}
.admin-team-calendar-unavailable-clear {
  appearance: none;
  min-height: 24px;
  padding: 0 8px;
...
.admin-team-calendar-unavailable-clear:hover,
.admin-team-calendar-unavailable-clear:focus-visible {
  border-color: rgba(185, 28, 28, 0.28);
  color: #991b1b;
}
.admin-team-calendar-unavailable-dialog .admin-team-calendar-unavailable-panel {
  width: min(420px, calc(100vw - 32px));
}
.admin-team-calendar-unavailable-form {
  gap: 12px;
}
