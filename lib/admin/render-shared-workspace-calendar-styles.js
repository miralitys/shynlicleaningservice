...
.admin-team-calendar-cell-timeline {
  position: relative;
  display: block;
  min-height: var(--admin-team-calendar-timeline-height, 190px);
  isolation: isolate;
}
.admin-team-calendar-time-slot {
  display: grid;
  align-content: start;
  gap: 6px;
  height: var(--admin-team-calendar-slot-height, 78px);
  min-width: 0;
  padding-bottom: 6px;
  box-sizing: border-box;
}
.admin-team-calendar-time-slot .admin-team-calendar-entry {
  height: 72px;
  box-sizing: border-box;
}
.admin-team-calendar-time-slot-empty {
  pointer-events: none;
}
.admin-team-calendar-entry-positioned {
  position: absolute;
  top: var(--admin-team-calendar-entry-top, 0%);
  left: 0;
  z-index: 2;
  height: max(54px, var(--admin-team-calendar-entry-height, 54px));
  max-height: calc(100% - var(--admin-team-calendar-entry-top, 0%));
}
.admin-team-calendar-entry-unavailable.admin-team-calendar-entry-positioned {
  z-index: 1;
  min-height: 34px;
  height: max(34px, var(--admin-team-calendar-entry-height, 34px));
  background: rgba(75, 85, 99, 0.12);
}
.admin-team-calendar-entry-unavailable-all-day.admin-team-calendar-entry-positioned {
  inset: 0;
  width: 100%;
  height: 100%;
  max-height: none;
...
.admin-team-calendar-cell-menu[open] {
  position: relative;
  top: auto;
  right: auto;
...
.admin-team-calendar-cell-menu[open] .admin-team-calendar-cell-menu-popover {
  position: relative;
  top: auto;
  right: auto;
  width: 100%;
...
.admin-team-calendar-busy-settings {
  display: grid;
  gap: 8px;
  margin-top: 6px;
...
.admin-team-calendar-busy-settings[hidden],
.admin-team-calendar-busy-time-range[hidden] {
  display: none;
}
.admin-team-calendar-busy-field {
  display: grid;
  gap: 4px;
  color: #475569;
  font-size: 10px;
...
.admin-team-calendar-busy-field select,
.admin-team-calendar-busy-field input {
  width: 100%;
  min-width: 0;
  min-height: 34px;
  padding: 6px 8px;
...
.admin-team-calendar-busy-time-range {
  display: grid;
  grid-template-columns: minmax(0, 1fr) minmax(0, 1fr);
  gap: 8px;
}
.admin-team-calendar-busy-save {
  min-height: 34px;
  border: 0;
  border-radius: 6px;
  background: var(--admin-staff-color, #2563eb);
...
.admin-team-calendar-busy-save:hover,
.admin-team-calendar-busy-save:focus-visible {
