...
function buildInviteEmailCopy({ staffName, verifyUrl, loginUrl }) {
  ...
  const text = [
    ...
    safeVerifyUrl,
    "",
    "After confirmation, open the employee login page, enter your work email, and set your password:",
    safeLoginUrl,
    "",
        ...
        <tr>
          <td style="padding:32px 32px 16px;">
            ...
            <p style="margin:0 0 24px;font-size:17px;line-height:1.6;color:#52525b;">
              Confirm your email first. After that, enter your work email on the login page and create your own password.
            </p>
...
function buildW9ReminderEmailCopy({
  ...
  const text = [
    `Hello ${safeName},`,
    "",
    "Please complete your SHYNLI W-9 in your employee account.",
    needsSetup
      ? "Open this secure link first so you can confirm your email or finish setting up access:"
      : "Sign in to your employee account here:",
    needsSetup ? safeVerifyUrl : safeLoginUrl,
    needsSetup
      ? [
          "",
          "After that, open the employee login page and complete the W-9 form:",
          safeLoginUrl,
        ].join("\n")
      : "",
    "",
    "The form will automatically generate the PDF and attach it to your employee profile.",
    "",
    "If you did not expect this message, please ignore it.",
    "",
    "SHYNLI CLEANING",
    ...
    <body style="margin:0;padding:24px;background:#f6f7fb;font-family:Montserrat,'Segoe UI',sans-serif;color:#18181b;">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px;margin:0 auto;background:#ffffff;border:1px solid #e4e4e7;border-radius:24px;overflow:hidden;">
        <tr>
          <td style="padding:32px 32px 16px;">
            <div style="font-size:12px;letter-spacing:.12em;text-transform:uppercase;color:#9e435a;font-weight:700;">SHYNLI CLEANING</div>
            <h1 style="margin:14px 0 10px;font-size:30px;line-height:1.1;">Complete your W-9</h1>
            <p style="margin:0 0 14px;font-size:17px;line-height:1.6;color:#52525b;">
              Hello ${escapeHtml(safeName)}, please return to your employee account and finish the W-9 form.
            </p>
            <p style="margin:0 0 24px;font-size:17px;line-height:1.6;color:#52525b;">
              Once submitted, SHYNLI will generate the PDF automatically and attach it to your employee profile.
            </p>
            <p style="margin:0 0 28px;">
              <a href="${escapeHtml(safeLoginUrl)}" style="display:inline-block;padding:15px 24px;border-radius:999px;background:#9e435a;color:#ffffff;text-decoration:none;font-size:16px;font-weight:700;">Open employee account</a>
            </p>
            ${setupBlock}
          </td>
        </tr>
