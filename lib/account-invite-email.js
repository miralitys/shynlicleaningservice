...
function buildW9ReminderEmailCopy({
  ...
  const text = [
    ...
    "Use the main button to continue directly into the W-9 flow.",
    needsSetup
      ? "If the system still needs email confirmation or first-password setup, it will guide you through that first:"
      : "Sign in here and the system will open the W-9 section:",
    primaryUrl,
    needsSetup
      ? [
          "",
      ...
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px;margin:0 auto;background:#ffffff;border:1px solid #e4e4e7;border-radius:24px;overflow:hidden;">
        <tr>
          <td style="padding:32px 32px 16px;">
            ...
            <p style="margin:0 0 14px;font-size:17px;line-height:1.6;color:#52525b;">
              Hello ${escapeHtml(safeName)}, use the button below and the system will take you straight into the W-9 flow.
            </p>
            <p style="margin:0 0 24px;font-size:17px;line-height:1.6;color:#52525b;">
              Once submitted, SHYNLI will generate the PDF automatically and attach it to your employee profile.
            </p>
            <p style="margin:0 0 28px;">
              <a href="${escapeHtml(primaryUrl)}" style="display:inline-block;padding:15px 24px;border-radius:999px;background:#9e435a;color:#ffffff;text-decoration:none;font-size:16px;font-weight:700;">Open W-9 form</a>
            </p>
            ${setupBlock}
          </td>
        </tr>
